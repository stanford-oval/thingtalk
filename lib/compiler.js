...
module.exports = new lang.Class({
        ...
        return Q.try(function() {
            ...
            return {
                ...
                produce: function(env) {
                    ...
                    if (isTuple && params.length === type.schema.length)
                        return toJS(type, v);
                    else
    ...
    compileOutputs: function(ast, scope) {
        return Q.all(ast.outputs.map(function(out) {
    ...
    compileRule: function(ast) {
        ...
        return this.compileInputs(ast).then(function(inputs) {
            ...
            delete inputs.scope;
            return this.compileOutputs(ast, scope).then(function(outputs) {
                var retval = { inputs: inputs, outputs: outputs };
