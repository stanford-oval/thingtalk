...
module.exports = new lang.Class({
    ...
    compileInputKeyword: function(ast, forTrigger, scope) {
    ...
    compileInputInvocation: function(ast, forTrigger, scope) {
        ...
        if (selector.isBuiltin) {
            ...
            if (forTrigger) {
                ...
                if (!(name in Builtin.Queries))
                    throw new TypeError('Unknown built-in ' + name);
                schema = Q(Builtin.Queries[name]);
            }
            ...
            if (moduleName in this._scope) {
                ...
                if (forTrigger)
                    ...
                    schema = this._getSchema(selector.name, 'queries', ast.name);
            }
        } else {
            var type = null;
            ...
            if (forTrigger)
                ...
                schema = this._getSchema(type, 'queries', ast.name);
        }
    ...
    compileInputs: function(inputs, forTrigger, scope) {
