...
class SmtReduction {
    constructor() {
        ...
        this._declareEntityType(Type.Entity('tt:contact_group'));
        this._declarations.push(smt.DeclareFun('group.member', ['Entity_tt_contact', 'Entity_tt_contact_group'], 'Bool'));
        this._enumtypes = [];
    ...
    _filterToSmt(operator, param, value) {
        ...
        case 'group_member':
            return smt.Predicate('group.member', param, value);
        default:
