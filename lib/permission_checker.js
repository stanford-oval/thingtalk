...
function partiallyEvalFilter(expr, scope, inParamMap, groupmap, replaceVariables) {
...
module.exports = class PermissionChecker {
    ...
    _adjustCommon(oldfn, newfn, scope) {
        ...
        return promiseDoAll(allowedRules, (allowed) => {
            ...
            let result = [optimizeFilter(partiallyEvalFilter(Ast.BooleanExpression.Or(preconditions), scope, inParamMap, this._groupmap, true)),
                          optimizeFilter(partiallyEvalFilter(Ast.BooleanExpression.And(postconditions), scope, inParamMap, this._groupmap, false))];
