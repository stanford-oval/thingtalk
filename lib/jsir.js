...
class CreateAggregation {
    ...
    codegen(prefix) {
        ...
        return prefix + '_t_' + this._into + ' = new Ast.Aggregation("' + type + ', ' + field + ', ' + cols + ');';
    }
}
...
class InvokeMemoryQuery {
    constructor(into, args, aggregation) {
        this._into = into;
        this._args = args;
        this._aggregation = aggregation;
    }
    ...
    codegen(prefix) {
        ...
        return prefix + '_t_' + this._into + ' = yield env.invokeMemoryQuery(_t_' + this._args + ', ' + aggregation + ');';
    }
}
