...
export {
    Describer,
    pubDescribeArg as describeArg,
    pubDescribeFilter as describeFilter,
    pubDescribeProgram as describeProgram,
    pubDescribePrimitive as describePrimitive,
    pubDescribeStream as describeStream,
    pubDescribeTable as describeTable,
    pubDescribePermissionRule as describePermissionRule,
    pubDescribePermissionFunction as describePermissionFunction,
    pubGetProgramName as getProgramName
};
