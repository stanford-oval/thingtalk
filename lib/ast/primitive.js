...
class VarRefTable extends Table {
    ...
    async visit(visitor) {
        ...
        if (await visitor.visitVarRefTable(this)) {
            for (let in_param of this.in_params)
...
class ResultRefTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitResultRefTable(this))
            await this.index.visit(visitor);
        await visitor.exit(this);
    }
...
class InvocationTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitInvocationTable(this))
            await this.invocation.visit(visitor);
        await visitor.exit(this);
    }
...
class FilteredTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitFilteredTable(this)) {
            await this.table.visit(visitor);
            await this.filter.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class ProjectionTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitProjectionTable(this))
            await this.table.visit(visitor);
        await visitor.exit(this);
    }
...
class ComputeTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitComputeTable(this)) {
            await this.table.visit(visitor);
            await this.expression.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class AliasTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAliasTable(this));
            await this.table.visit(visitor);
        await visitor.exit(this);
    }
...
class AggregationTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAggregationTable(this));
        await visitor.exit(this);
    }
...
class SortedTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitSortedTable(this))
            await this.table.visit(visitor);
        await visitor.exit(this);
    }
...
class IndexTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitIndexTable(this)) {
            await this.table.visit(visitor);
            for (let index of this.indices)
                await index.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class SlicedTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitSlicedTable(this)) {
            await this.table.visit(visitor);
            await this.base.visit(visitor);
            await this.limit.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class JoinTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitJoinTable(this)) {
            await this.lhs.visit(visitor);
            await this.rhs.visit(visitor);
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
        }
        await visitor.exit(this);
...
class WindowTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitWindowTable(this)) {
            await this.stream.visit(visitor);
            await this.base.visit(visitor);
            await this.delta.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class TimeSeriesTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitTimeSeriesTable(this)) {
            await this.stream.visit(visitor);
            await this.base.visit(visitor);
            await this.delta.visit(visitor);
        }
...
class SequenceTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitSequenceTable(this)) {
            await this.table.visit(visitor);
            await this.base.visit(visitor);
            await this.delta.visit(visitor);
        }
...
class HistoryTable extends Table {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitHistoryTable(this)) {
            await this.table.visit(visitor);
            await this.base.visit(visitor);
            await this.delta.visit(visitor);
        }
...
class VarRefStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitVarRefStream(this)) {
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
        }
        await visitor.exit(this);
...
class TimerStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitTimerStream(this)) {
            await this.base.visit(visitor);
            await this.interval.visit(visitor);
            if (this.frequency !== null)
                await this.frequency.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class AtTimerStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAtTimerStream(this)) {
            for (let time of this.time)
                await time.visit(visitor);
            if (this.expiration_date !== null)
                await this.expiration_date.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class MonitorStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitMonitorStream(this))
            await this.table.visit(visitor);
        await visitor.exit(this);
    }
...
class EdgeNewStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitEdgeNewStream(this))
            await this.stream.visit(visitor);
        await visitor.exit(this);
    }
...
class EdgeFilterStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitEdgeFilterStream(this)) {
            await this.stream.visit(visitor);
            await this.filter.visit(visitor);
        }
        await visitor.exit(this);
...
class FilteredStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitFilteredStream(this)) {
            await this.stream.visit(visitor);
            await this.filter.visit(visitor);
        }
        await visitor.exit(this);
...
class ProjectionStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitProjectionStream(this))
            await this.stream.visit(visitor);
        await visitor.exit(this);
    }
...
class ComputeStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitComputeStream(this)) {
            await this.stream.visit(visitor);
            await this.expression.visit(visitor);
        }
        await visitor.exit(this);
...
class AliasStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAliasStream(this))
            await this.stream.visit(visitor);
        await visitor.exit(this);
    }
...
class JoinStream extends Stream {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitJoinStream(this)) {
            await this.stream.visit(visitor);
            await this.table.visit(visitor);
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
...
class Action extends Node {
     ...
     *
     * @method Ast.Action#iteratePrimitives
     * @param {boolean} includeVarRef - whether to include local function calls (VarRef nodes)
     *                                  in the iteration
     * @generator
     * @yields {Ast.Invocation}
...
class VarRefAction extends Action {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitVarRefAction(this)) {
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
        }
        await visitor.exit(this);
...
class InvocationAction extends Action {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitInvocationAction(this))
            await this.invocation.visit(visitor);
        await visitor.exit(this);
    }
...
class SpecifiedPermissionFunction extends PermissionFunction {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitSpecifiedPermissionFunction(this))
            await this.filter.visit(this);
        await visitor.exit(this);
    }
...
class BuiltinPermissionFunction extends PermissionFunction {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitBuiltinPermissionFunction(this);
        await visitor.exit(this);
    }
...
class ClassStarPermissionFunction extends PermissionFunction {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitClassStarPermissionFunction(this);
        await visitor.exit(this);
    }
...
class StarPermissionFunction extends PermissionFunction {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitStarPermissionFunction(this);
        await visitor.exit(this);
    }
