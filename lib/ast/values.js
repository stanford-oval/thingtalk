...
class Value extends AstNode {
    ...
    static fromJS(type, v) {
        ...
        if (type.isRecurrentTimeSpecification)
            return new Value.RecurrentTimeSpecification(v.map((r) => RecurrentTimeRule.fromJS(r)));
        if (type.isArgMap) {
            let map = {};
 ...
 */
class RecurrentTimeRule extends AstNode {
...
module.exports.RecurrentTimeRule = RecurrentTimeRule;
