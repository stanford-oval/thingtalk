 ...
 *
 * @extends {module:Ast.Statement}
 * @alias module:Ast.ClassDef
 */
class ClassDef extends Statement {
     ...
     * @param {module:Ast.ClassDef[]|null} _extends - parent classes (if any)
     * @param {Object.<string, module:Ast.FunctionDef>} queries - query functions in this class
     * @param {Object.<string, module:Ast.FunctionDef>} actions - action functions in this class
     * @param {module:Ast.ImportStmt[]} imports - import statements in this class
     * @param {Object.<string, module:Ast.Value>} annotations - class annotations
    ...
    *iteratePrimitives() {}
     ...
     *
     * @type {module:Ast.ImportStmt|undefined}
     * @readonly
     */
    get loader() {
     ...
     * @return {module:Ast.ClassDef} the converted class definition
     * @deprecated Manifests are deprecated and should not be used. Use .tt files instead.
     */
