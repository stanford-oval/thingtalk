...
const { InputParam } = require('./primitive');
...
class ClassDef extends Statement {
     ...
     */
    constructor(kind, _extends, members, annotations, options) {
        super();
        this.name = kind;
        this.kind = kind;
    ...
    *iteratePrimitives() {}
    ...
    _adjustParentPointers() {
        for (let name in this.queries)
            this.queries[name]._class = this;
        for (let name in this.actions)
            this.actions[name]._class = this;
    }
    ...
    clone() {
        ...
        // clone other options
        const options = {
            is_abstract: this.options.is_abstract || false
        };

        return new ClassDef(this.kind, this.extends, members, annotations, options);
    }
     ...
     * of {@link Ast.ClassDef#nl_annotations}. It will return `undefined`
     ...
     *
     * This is a convenience property for accessing the `is_abstract` property
     * of {@link Ast.ClassDef#options}.
     * @type {string}
     * @readonly
     */
    get is_abstract() {
        return this.options && this.options.is_abstract ? this.options.is_abstract : false;
    }
    ...
    static fromManifest(kind, manifest) {
        ...
        return new ClassDef(kind, _extends, { queries, actions, imports }, { nl: metadata, impl: annotations }, {});
    }
}
