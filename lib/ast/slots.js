...
class ArrayIndexSlot extends AbstractSlot {
    ...
    getPrompt(locale) {
        ...
        case 'compute_filter.lhs':
            ...
            switch (this._index) {
            case 0:
                return _("What is the first value of the filter left hand side?");
            case 1:
                return _("What is the second value of the filter left hand side?");
            case 2:
                return _("What is the third value of the filter left hand side?");
            default:
                return _("What is the %dth value of the filter left hand side?").format(this._index+1);
            }
        case 'compute_filter.rhs':
            ...
            switch (this._index) {
            case 0:
                return _("What is the first value of the filter right hand side?");
            case 1:
                return _("What is the second value of the filter right hand side?");
            case 2:
                return _("What is the third value of the filter right hand side?");
            default:
                return _("What is the %dth value of the filter right hand side?").format(this._index+1);
            }
