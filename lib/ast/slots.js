...
class InputParamSlot extends AbstractSlot {
    ...
    getPrompt(locale) {
        ...
        return _("Please tell me the %s.").format(canonical);
    }
    get() {
...
class FilterSlot extends AbstractSlot {
    ...
    getPrompt(locale) {
        ...
        switch (this._filter.operator) {
        case '>=':
            return _("What should the %s be greater than?").format(canonical);
        case '<=':
            return _("What should the %s be less than?").format(canonical);
        case 'starts_with':
            return _("How should the %s start with?").format(canonical);
        case 'ends_with':
            return _("How should the %s end with?").format(canonical);
        case '=~':
            return _("What should the %s contain?").format(canonical);
        case '==':
            return _("What should the %s be equal to?").format(canonical);
        default:
            // ugly default but guaranteed to work...
            return _("Please tell me the value of the filter on the %s.").format(canonical);
        }
    }
    get() {
