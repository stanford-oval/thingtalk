 ...
 * @return {module:Ast.Action} the action node
 * @alias module:Ast.notifyAction
 */
 ...
 * @return {module:Ast.Input.Library} the converted library
 * @deprecated Manifests are deprecated and should not be used. Use .tt files instead.
 * @alias module:Ast.fromManifest
 */
 ...
 *
 * @param {module:Ast.Input.Library} meta - the library to convert
 * @return {Object} the manifest
 * @deprecated Manifests are deprecated and should not be used. Use .tt files instead.
 * @alias module:Ast.toManifest
 */
 ...
 *
 * @return {module:Ast.Input.Program} the new program
 * @alias module:Ast.Statement.Declaration.toProgram
 */
 ...
 *
 * @return {module:Ast.Input.Program} the new program
 * @alias module:Ast.Example.toProgram
 */
