...
import { PermissionFunction } from './primitive';
import { Value } from './values';
import {
    isRemoteSend,
    isRemoteReceive
} from './remote_utils';
import { PermissionRule } from './program';
...
export default function convertToPermissionRule(program, principal, contactName) {
    let rule;
