 ...
 */
class PredicateBookeepingIntent extends BookkeepingIntent {
    /**
     * Construct a new answer command.
     *
     * @param {Ast~SourceRange|null} location - the position of this node
    ...
    clone() {
        return new PredicateBookeepingIntent(this.location, this.predicate);
    }
}
PredicateBookeepingIntent.prototype.isPredicate = true;
BookkeepingIntent.Predicate = PredicateBookeepingIntent;
