...
class Bookkeeping extends Input {
    ...
    async visit(visitor) {
        ...
        if (await visitor.visitBookkeeping(this))
            await this.intent.visit(visitor);
...
class SpecialBookkeepingIntent extends BookkeepingIntent {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitSpecialBookkeepingIntent(this);
        await visitor.exit(this);
    }
...
class ChoiceBookkeepingIntent extends BookkeepingIntent {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitChoiceBookkeepingIntent(this);
        await visitor.exit(this);
    }
...
class CommandListBookkeepingIntent extends BookkeepingIntent {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitCommandListBookkeepingIntent(this))
            await this.device.visit(visitor);
        await visitor.exit(this);
    }
...
class AnswerBookkeepingIntent extends BookkeepingIntent {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAnswerBookkeepingIntent(this))
...
class PredicateBookkeepingIntent extends BookkeepingIntent {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitPredicateBookkeepingIntent(this))
            await this.predicate.visit(visitor);
        await visitor.exit(this);
    }
