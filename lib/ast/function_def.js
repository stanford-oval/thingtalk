...
class ArgumentDef {
     ...
     */
    constructor(direction, name, type, annotations = {}) {
        /**
    ...
    *_iterateCompoundArrayFields(compound, prefix='') {
    ...
    clone() {
        ...
        return new ArgumentDef(this.direction, this.name, this.type, { nl, impl });
    }
    ...
    static fromManifest(manifest) {
        ...
        return new ArgumentDef(direction, name, type, { nl: metadata, impl: annotations });
    }
}
