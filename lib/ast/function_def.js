 ...
 * @extends Ast~Node
 */
class ArgumentDef extends Node {
    /**
    ...
    *_iterateCompoundArrayFields(compound, prefix='') {
    ...
    async visit(visitor) {
        ...
        await visitor.visitArgumentDef(this);
 ...
 * @extends Ast~Node
 */
class ExpressionSignature extends Node {
    /**
...
class FunctionDef extends ExpressionSignature {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitFunctionDef(this)) {
            for (let arg of this.args)
                await this._argmap[arg].visit(visitor);
        }
        await visitor.exit(this);
    }
    ...
    _cloneInternal(args, flattened=false) {
        ...
        return new FunctionDef(this.location, this.functionType, this.class,
            this.name, this.extends, qualifiers, args, annotations);
    }
