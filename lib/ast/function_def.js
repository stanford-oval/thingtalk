...
class ExpressionSignature {
     ...
     * @param {Object.<string, any>} options - additional options of the function
     * @param {boolean} options.is_list - whether this signature defines a `list` query function
     * @param {boolean} options.is_monitorable - whether this signature defines a `monitorable` query function
     ...
     * @package
     */
    //constructor(functionType, _extends, args, options) {
     ...
     *
     * @param {Set) returned - a set of returned argument names to avoide duplicates
...
class FunctionDef extends ExpressionSignature {
     ...
     * @param {Object.<string, Ast.Value>} annotations - function annotations
     */
