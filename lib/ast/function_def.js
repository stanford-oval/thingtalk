...
class ArgumentDef {
    ...
    constructor(direction, name, type, metadata, annotations) {
         ...
         * @type {Object.<string,module:Ast.Value>}
         */
     ...
     *
     * @return {module:Ast.ArgumentDef} the new instance
     */
    clone() {
        const metadata = {};
 ...
 *
 * @param {module:Ast.ArgumentDef} arg - the argument to check
 * @return {boolean} whether the argument passes the filter
 * @callback module:Ast~ArgumentFilterCallback
 */
 ...
 * that node.
 *
 * @alias module:Ast.ExpressionSignature
 */
class ExpressionSignature {
    /**
     * Construct a new expression signature.
     *
     * Client code should not construct {@link module:Ast.ExpressionSignature},
     * and should prefer constructing {@link module:Ast.FunctionDef} instead.
     *
     ...
     * @param {module:Ast.ArgumentDef[]} args - the arguments in this signature
     * @param {boolean} is_list - whether this signature defines a `list` query function
     * @param {boolean} is_monitorable - whether this signature defines a `monitorable` query function
     * @param {boolean} [require_filter=false] - whether this expression must be filtered to typecheck correctly
     * @param {string[]} [default_projection=[]] - list of argument names that are applied as projection to this function
     *                                        when no other projection is present
     * @param {boolean} [no_filter=false] - whether filtering is allowed on expressions with this signature
     * @internal
     */
    constructor(functionType, _extends, args, is_list, is_monitorable, require_filter, default_projection, no_filter, parent = null) {
         ...
         * @type {string[]}
         * @readonly
         * @deprecated Use {@link module:Ast.ExpressionSignature#getArgument} and
         *             {@link module:Ast.ArgumentDef#canonical} instead.
         */
        this.argcanonicals = [];
         ...
         * @readonly
         * @deprecated Use {@link module:Ast.ExpressionSignature#getArgument} and
         *             {@link module:Ast.ArgumentDef#metadata}`.prompt` instead.
         */
        this.questions = [];
     ...
     *
     * @param {string} arg - the argument name
     * @return {module:Ast.ArgumentDef|undefined} the argument definition, or `undefined`
     ...
     *
     * This is a convenience method that combines {@link module:Ast.ExpressionSignature#getArgument}
     * and {@link module:Ast.ArgumentDef#type}.
     *
     * @param {string} arg - the argument name
     ...
     *
     * This is a convenience method that combines {@link module:Ast.ExpressionSignature#getArgument}
     * and {@link module:Ast.ArgumentDef#canonical}.
     *
     * @param {string} arg - the argument name
     ...
     *
     * This is a convenience method that combines {@link module:Ast.ExpressionSignature#getArgument}
     * and {@link module:Ast.ArgumentDef#metadata}.
     *
     * @param {string} arg - the argument name
     ...
     *
     * This is a convenience method that combines {@link module:Ast.ExpressionSignature#getArgument}
     * and {@link module:Ast.ArgumentDef#is_input}.
     *
     * @param {string} arg - the argument name
     ...
     *
     * This is a convenience method that combines {@link module:Ast.ExpressionSignature#getArgument}
     * and {@link module:Ast.ArgumentDef#required}.
     *
     * @param {string} arg - the argument name
    ...
    *iterateArguments() {
     ...
     * constructor.
     *
     * @param {module:Ast.ArgumentDef[]} args - the arguments in the new signature
     * @param {boolean} flattened - whether the new signature should be flattened or it
     *        it should preserve the extension relation
     * @return {module:Ast.ExpressionSignature} a clone of this signature, with a new
     *         set of arguments.
     */
     ...
     *
     * @return {module:Ast.ExpressionSignature} a clone of this signature
     */
    clone() {
     ...
     * the added argument.
     *
     * @param {module:Ast.ArgumentDef} toAdd - the argument to add
     * @return {module:Ast.ExpressionSignature} a clone of this signature with a new argument
     */
    addArguments(toAdd) {
     ...
     * @return {module:Ast.ExpressionSignature} a clone of this signature with one fewer argument
     */
    removeArgument(arg) {
        if (arg in this._argmap) {
     ...
     *
     * @param {module:Ast~ArgumentFilterCallback} filter - a filter callback
     * @return {module:Ast.ExpressionSignature} a clone of this signature
     */
     ...
     * order returned by {@link module:Ast.ExpressionSignature#iterateArguments}.
     * @type {Type[]}
     * @readonly
     ...
     *             Use {@link module:Ast.ExpressionSignature#iterateArguments} instead.
     */
    get types() {
        if (this.extends.length === 0)
            return this._types;
 ...
 *
 * A function definition is a particular type of {@link module:Ast.ExpressionSignature}
 * that also has a name and annotations.
 *
 * Function definitions are semi-immutable: you should not modify a function definition
 * received from outside. Instead, you should call {@link module:Ast.FunctionDef#clone}
 * to create a new instance you can modify. This includes modifying metadata and annotations
 * throw the {@link module:Ast.FunctionDef#metadata} and {@link module:Ast.FunctionDef#annotations}
 * properties. Failure to call {@link module:Ast.FunctionDef#clone} will result in obsure
 * type checking errors.
 *
 * @alias module:Ast.FunctionDef
 * @extends module:Ast.ExpressionSignature
 */
class FunctionDef extends ExpressionSignature {
     ...
     * @param {module:Ast.ArgumentDef[]} args - the arguments in this function
     * @param {boolean} is_list - whether this function defines a `list` query
     * @param {boolean} is_monitorable - whether this function defines a `monitorable` query
     * @param {Object.<string, any>} metadata - function metadata (translatable annotations)
     * @param {Object.<string, module:Ast.Value>} annotations - function annotations
     */
     ...
     * Convert this function definition to prettyprinted ThingTalk code.
     *
     * This is an alias for {@link module:Ast.FunctionDef#toString}.
     *
     * @param {string} [prefix] - prefix each output line with this string (for indentation)
     * @return {string} the prettyprinted code
     */
     ...
     * of {@link module:Ast.FunctionDef#metadata} because it will ensure
     ...
     * of {@link module:Ast.FunctionDef#metadata}. It will return `undefined`
