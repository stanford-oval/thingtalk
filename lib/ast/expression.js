...
class DeviceSelector extends Selector {
    ...
    async visit(visitor) {
        ...
        if (await visitor.visitDeviceSelector(this)) {
            for (let attr of this.attributes)
                await attr.visit(visitor);
        }
...
class BuiltinSelector extends Selector {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitBuiltinSelector(this);
        await visitor.exit(this);
    }
...
class InputParam extends Node {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitInputParam(this))
...
class Invocation extends Node {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitInvocation(this)) {
            await this.selector.visit(visitor);
...
class BooleanExpression extends Node {
     ...
     *
     * @method Ast.BooleanExpression#iteratePrimitives
...
class AndBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAndBooleanExpression(this)) {
            for (let operand of this.operands)
                await operand.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class OrBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitOrBooleanExpression(this)) {
            for (let operand of this.operands)
                await operand.visit(visitor);
        }
        await visitor.exit(this);
...
class AtomBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAtomBooleanExpression(this))
            await this.value.visit(visitor);
        await visitor.exit(this);
    }
...
class NotBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitNotBooleanExpression(this))
            await this.expr.visit(visitor);
        await visitor.exit(this);
    }
...
class ExternalBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitExternalBooleanExpression(this)) {
            await this.selector.visit(visitor);
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
...
class TrueBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitTrueBooleanExpression(this);
        await visitor.exit(this);
    }
...
class FalseBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        await visitor.visitFalseBooleanExpression(this);
        await visitor.exit(this);
    }
...
class VarRefBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitVarRefBooleanExpression(this)) {
            await this.selector.visit(visitor);
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
        }
...
class ComputeBooleanExpression extends BooleanExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitComputeBooleanExpression(this)) {
...
class ListExpression extends Node {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitListExpression(this)) {
            if (this.filter !== null)
                await this.filter.visit(visitor);
        }
        await visitor.exit(this);
...
class PrimaryScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitPrimaryScalarExpression(this))
            await this.value.visit(visitor);
        await visitor.exit(this);
    }
...
class DerivedScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitDerivedScalarExpression(this)) {
            for (let op of this.operands)
                await op.visit(visitor);
        }
        await visitor.exit(this);
    }
...
class AggregationScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitAggregationScalarExpression(this))
            await this.list.visit(visitor);
        await visitor.exit(this);
    }
...
class FilterScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitFilterScalarExpression(this))
            await this.list.visit(visitor);
        await visitor.exit(this);
    }
...
class FlattenedListScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitFlattenedListScalarExpression(this))
            await this.list.visit(visitor);
        await visitor.exit(this);
    }
...
class VarRefScalarExpression extends ScalarExpression {
    ...
    async visit(visitor) {
        await visitor.enter(this);
        if (await visitor.visitVarRefScalarExpression(this)) {
            await this.selector.visit(visitor);
            for (let in_param of this.in_params)
                await in_param.visit(visitor);
        }
