 ...
 *
 * @class
 * @alias module:Ast.Selector
 * @property {boolean} isDevice - true if this is an instance of {@link module:Ast.Selector.Device}
 * @property {boolean} isBuiltin - true if this is {@link module:Ast.Selector.Builtin}
 * @abstract
 */
const Selector = adt.data(/** @lends module:Ast.Selector */ {
    /**
     * A selector that maps to one or more devices in Thingpedia.
     *
     * @class
     * @extends module:Ast.Selector
     ...
     */
    Device: /** @lends module:Ast.Selector.Device.prototype */ {
        /**
 ...
 *
 * @class
 * @alias module:Ast.Invocation
 * @param {module:Ast.Selector} selector - the selector choosing where the function is invoked
 * @param {string} channel - the function name
 * @param {module:Ast.InputParam[]} in_params - input parameters passed to the function
 * @param {module:Ast.ExpressionSignature|null} schema - type signature of the invoked function
 */
const Invocation = adt.newtype('Invocation', /** @lends module:Ast.Invocation.prototype */ {
    /**
     ...
     * @type {module:Ast.ExpressionSignature|null}
     * @readonly
     */
 ...
 *
 * @class
 * @alias module:Ast.BooleanExpression
 * @abstract
 * @property {boolean} isAnd - true if this is an instance of {@link module:Ast.BooleanExpression.And}
 * @property {boolean} isOr - true if this is an instance of {@link module:Ast.BooleanExpression.Or}
 * @property {boolean} isAtom - true if this is an instance of {@link module:Ast.BooleanExpression.Atom}
 * @property {boolean} isNot - true if this is an instance of {@link module:Ast.BooleanExpression.Not}
 * @property {boolean} isExternal - true if this is an instance of {@link module:Ast.BooleanExpression.External}
 * @property {boolean} isTrue - true if this is {@link module:Ast.BooleanExpression.True}
 * @property {boolean} isFalse - true if this is {@link module:Ast.BooleanExpression.False}
 */
const BooleanExpression = adt.data(function() {
    return /** @lends module:Ast.BooleanExpression */ {
        /**
         * A conjunction boolean expression (ThingTalk operator `&&`)
         * @class
         * @extends module:Ast.BooleanExpression
         * @param {module:Ast.BooleanExpression[]} operands - the expression operands
         */
        And: /** @lends module:Ast.BooleanExpression.And.prototype */ {
            /**
         ...
         * @param {module:Ast.BooleanExpression[]} operands - the expression operands
         */
        Or: /** @lends module:Ast.BooleanExpression.Or.prototype */ {
            /**
             * The expression operands.
             * @type {module:Ast.BooleanExpression[]}
             * @readonly
         ...
         * @param {module:Ast.Value} value - the value being compared against
         */
        Atom: /** @lends module:Ast.BooleanExpression.Atom.prototype */ {
            /**
         ...
         * @class
         * @extends module:Ast.BooleanExpression
         * @param {module:Ast.BooleanExpression} expr - the expression being negated
         */
        Not: /** @lends module:Ast.BooleanExpression.Not.prototype */ {
            /**
         ...
         * @class
         * @extends module:Ast.BooleanExpression
         * @param {module:Ast.Selector.Device} selector - the selector choosing where the function is invoked
         * @param {string} channel - the function name
         * @param {module:Ast.InputParam[]} in_params - input parameters passed to the function
         * @param {module:Ast.BooleanExpression} filter - the filter to apply on the invocation's results
         * @param {module:Ast.ExpressionSignature|null} schema - type signature of the invoked function
         */
        External: /** @lends module:Ast.BooleanExpression.External.prototype */ {
            /**
             * The selector choosing where the function is invoked.
             * @type {module:Ast.Selector}
             * @readonly
 ...
 *
 * @class
 * @alias module:Ast.InputParam
 * @param {string} name - the input argument name
 * @param {module:Ast.Value} value - the value being passed
 */
const InputParam = adt.newtype('InputParam', /** @lends module:Ast.InputParam.prototype */ {
    /**
 ...
 *
 * @class
 * @alias module:Ast.Action
 * @abstract
 * @property {boolean} isVarRef - true if this is an instance of {@link module:Ast.Action.VarRef}
 * @property {boolean} isInvocation - true if this is an instance of {@link module:Ast.Action.Invocation}
 */
const Action = adt.data(/** @lends module:Ast.Action */{
    /**
     * An invocation of a locally defined action (i.e. one defined with
     * a `let` statement).
     *
     * @class
     * @extends module:Ast.Action
     * @param {string} name - the name of the action to invoke
     * @param {module:Ast.InputParam[]} in_params - the input parameters to pass
     * @param {module:Ast.ExpressionSignature|null} schema - type signature of this action
     */
    VarRef: /** @lends module:Ast.Action.VarRef.prototype */ {
        name: adt.only(String),
        in_params: adt.only(Array),
        schema: adt.only(ExpressionSignature, null),
    },
...
const ImportStmt = adt.data({
     ...
     *
     * @name module:Ast.ImportStmt.Class
     * @extends module:Ast.ImportStmt
     * @class
     ...
     */
    Class: /** @lends module:Ast.ImportStmt.Class.prototype */ {
        /**
     ...
     *
     * @name module:Ast.ImportStmt.Mixin
     * @extends module:Ast.ImportStmt
     * @class
     ...
     * @param {module:Ast.InputParam[]} in_params - input parameters to pass to the mixin
     */
    Mixin: /** @lends module:Ast.ImportStmt.Mixin.prototype */ {
        /**
