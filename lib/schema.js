...
module.exports = class SchemaRetriever {
    constructor(tpClient, ibaseClient, silent) {
    ...
    getMeta(kind, where, name) {
        switch (where) {
            case 'query': where = 'queries'; break;
            case 'action': where = 'actions'; break;
            case 'trigger': where = 'triggers'; break;
            default: break;
        }
