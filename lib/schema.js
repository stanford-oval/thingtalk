...
class SchemaRetriever {
     ...
     *
     * @param {module:Ast.ClassDef} classDef - class definition to inject
     */
     ...
     *
     * @param {string} kind - the class identifier
     * @return {module:Ast.ClassDef} the corresponding class
     * @async
     */
    getFullSchema(kind) {
     ...
     *
     * @param {string} kind - the class identifier
     * @return {module:Ast.ClassDef} the corresponding class, including metadata
     * @async
     */
    getFullMeta(kind) {
     ...
     * @param {string} functionType - the type of function (either `query` or `action`)
     * @param {string} name - the function name
     * @return {module:Ast.FunctionDef} the function definition
     * @async
     */
