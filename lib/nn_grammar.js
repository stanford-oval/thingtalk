...
module.exports = {
    ...
    '$program':       [[['$rule',], (rule) => new Ast.Program([], [], [rule], null)],
                       [['executor', '=', '$constant', ':', '$rule'], (_1, _2, user, _3, rule) => new Ast.Program([], [], [rule], user)]],
    ...
    '$stream':        [[['timer', 'base', '=', '$constant_Date', ',', 'interval', '=', '$constant_Measure(ms)'], (_1, _2, _3, base, _4, _5, _6, interval) => new Ast.Stream.Timer([base, interval], null)],
                       ...
                       [['attimer', 'time', '=', '[', '$time_list', ']'], (_1, _2, _3, _4, time_list, _5) => new Ast.Stream.AtTimer(time_list, null)],
    ...
    '$stream_join':   [[['(', '$stream', ')', '=>', '(', '$table', ')'], (_1, s1, _2, _3, _4, t2, _5) => new Ast.Stream.Join(s1, t2, [], null)],
                       [['(', '$stream', ')', 'join', '(', '$table', ')'], (_1, s1, _2, _3, _4, t2, _5) => new Ast.Stream.Join(s1, t2, [], null)],
    ...
    '$action':        [[['notify'], () => Generate.notifyAction()],
                       ...
                       [['$call'], (x) => new Ast.Action.Invocation(x, null)]],
    ...
    '$time_list': [[['$constant_Time'], (v) => [v]],
                   [['$time_list', ',', '$constant_Time'], (list, _, time) => list.concat([time])]],
    ...
    //values for days of week are consistent with ECMAScript 1 getDay() function
    '$constant_Dow': [[['Sunday'], () => new Ast.Value.Number(0)],
                      [['Monday'], () => new Ast.Value.Number(1)],
                      [['Tuesday'], () => new Ast.Value.Number(2)],
                      [['Wednesday'], () => new Ast.Value.Number(3)],
                      [['Thursday'], () => new Ast.Value.Number(4)],
                      [['Friday'], () => new Ast.Value.Number(5)],
                      [['Saturday'], () => new Ast.Value.Number(6)]],
