...
module.exports = class AppCompiler {
    ...
    _compileAssignment(assignment, irBuilder, hasAnyStream) {
        ...
        this._declarations.set(assignment.name, compiled);
    }
    ...
    _compileInScope(program, stmts, hasAnyStream) {
    ...
    async compileProgram(program) {
        ...
        const compiledCommand = this._compileInScope(program, immediate, rules.length > 0);
