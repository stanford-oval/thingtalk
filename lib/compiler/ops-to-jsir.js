...
module.exports = class OpCompiler {
    ...
    _compileInvokeTableVarRef(tableop) {
        let decl = this._compiler._getDeclaration(tableop.name);
    ...
    compileAssignment(tableop, isPersistent) {
        ...
        this._irBuilder.add(new JSIr.SetIndex(resultAndTypeTuple, 0, this._varScope.$outputType));
        this._irBuilder.add(new JSIr.SetIndex(resultAndTypeTuple, 1, this._varScope.$output));
