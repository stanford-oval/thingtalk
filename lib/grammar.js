module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c189 = "program_id",
        peg$c190 = { type: "literal", value: "program_id", description: "\"program_id\"" },
        peg$c191 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c192 = "^^",
        peg$c193 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c194 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c195 = function(values) {
            return Value.Array(values || []);
        },
        peg$c196 = "Measure",
        peg$c197 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c198 = function(unit) { return Type.Measure(unit); },
        peg$c199 = "Array",
        peg$c200 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c201 = function(type) { return Type.Array(type); },
        peg$c202 = "Enum",
        peg$c203 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c204 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c205 = "Entity",
        peg$c206 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c207 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c208 = "Any",
        peg$c209 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c210 = function() { return Type.Any; },
        peg$c211 = "Boolean",
        peg$c212 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c213 = function() { return Type.Boolean; },
        peg$c214 = "String",
        peg$c215 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c216 = function() { return Type.String; },
        peg$c217 = "Number",
        peg$c218 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c219 = function() { return Type.Number; },
        peg$c220 = "Location",
        peg$c221 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c222 = function() { return Type.Location; },
        peg$c223 = "Date",
        peg$c224 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c225 = function() { return Type.Date; },
        peg$c226 = "Time",
        peg$c227 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c228 = function() { return Type.Time; },
        peg$c229 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c230 = "EmailAddress",
        peg$c231 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c232 = function() { return Type.Entity('tt:email_address'); },
        peg$c233 = "PhoneNumber",
        peg$c234 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c235 = function() { return Type.Entity('tt:phone_number'); },
        peg$c236 = "Picture",
        peg$c237 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c238 = function() { return Type.Entity('tt:picture'); },
        peg$c239 = "Resource",
        peg$c240 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c241 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c242 = "URL",
        peg$c243 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c244 = function() { return Type.Entity('tt:url'); },
        peg$c245 = "Username",
        peg$c246 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c247 = function() { return Type.Entity('tt:username'); },
        peg$c248 = "Hashtag",
        peg$c249 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c250 = function() { return Type.Entity('tt:hashtag'); },
        peg$c251 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c252 = "true",
        peg$c253 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c254 = function() { return true; },
        peg$c255 = "false",
        peg$c256 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c257 = function() { return false; },
        peg$c258 = "max",
        peg$c259 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c260 = "min",
        peg$c261 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c262 = "sum",
        peg$c263 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c264 = "avg",
        peg$c265 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c266 = "count",
        peg$c267 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c268 = "argmax",
        peg$c269 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c270 = "argmin",
        peg$c271 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c272 = /^[^\\"]/,
        ...
        peg$c288 = { type: "other", description: "string" },
        peg$c289 = "\"",
        peg$c290 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c291 = function(chars) { return chars.join(''); },
        peg$c292 = "'",
        peg$c293 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c294 = { type: "other", description: "digit" },
        peg$c295 = /^[0-9]/,
        ...
        peg$c300 = "e",
        peg$c301 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c302 = function(num) { return parseFloat(num); },
        peg$c303 = /^[A-Za-z_]/,
        peg$c304 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c305 = /^[A-Za-z0-9_]/,
        peg$c306 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c307 = { type: "other", description: "ident" },
        peg$c308 = /^[A-Za-z0-9_\-]/,
        peg$c309 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c310 = { type: "other", description: "classident" },
        peg$c311 = { type: "other", description: "whitespace" },
        peg$c312 = /^[ \r\n\t\x0B]/,
        peg$c313 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        ...
        peg$c325 = /^[^\n]/,
        peg$c326 = { type: "class", value: "[^\\n]", description: "[^\\n]" },
        peg$c327 = "\n",
        peg$c328 = { type: "literal", value: "\n", description: "\"\\n\"" },
