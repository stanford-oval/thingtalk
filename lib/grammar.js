module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c75 = function(single) { return [single]; },
        peg$c76 = function(list) { return take(list, 1); },
        peg$c77 = "@$notify",
        peg$c78 = { type: "literal", value: "@$notify", description: "\"@$notify\"" },
        peg$c79 = function() {
            return new RulePart(Selector.Builtin, 'notify', [], BooleanExpression.True, [], null, null);
        },
        peg$c80 = "return",
        peg$c81 = { type: "literal", value: "return", description: "\"return\"" },
        peg$c82 = function() {
            return new RulePart(Selector.Builtin, 'return', [], BooleanExpression.True, [], null, null);
        },
        peg$c83 = function(fn, in_params) {
            let [selector, function_name] = fn;
            return RulePart(selector, function_name, in_params, BooleanExpression.True, [], null, null);
        },
        peg$c84 = function(type, values) {
            var id;
        ...
        peg$c86 = "id",
        peg$c87 = { type: "literal", value: "id", description: "\"id\"" },
        peg$c88 = "principal",
        peg$c89 = { type: "literal", value: "principal", description: "\"principal\"" },
        peg$c90 = "=",
        ...
        peg$c105 = function(or) { return or; },
        peg$c106 = function(v) { return v ? BooleanExpression.True : BooleanExpression.False; },
        peg$c107 = "!",
        peg$c108 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c109 = function(or) { return BooleanExpression.Not(or); },
        peg$c110 = function(f) { return f; },
        peg$c111 = function(outputs) { return take(outputs, 2); },
        peg$c112 = ":=",
        peg$c113 = { type: "literal", value: ":=", description: "\":=\"" },
        peg$c114 = function(name, param) {
            return OutputParam(name, param);
        },
        peg$c115 = function(l, r) {
            let out_params = [];
        ...
        peg$c123 = function(type, field, cols) {return Aggregation(type, field, cols);},
        peg$c124 = function(name, type, field) {
        ...
        peg$c140 = function(name) { return Value.VarRef(name); },
        peg$c141 = "$undefined",
        peg$c142 = { type: "literal", value: "$undefined", description: "\"$undefined\"" },
        peg$c143 = "remote",
        peg$c144 = { type: "literal", value: "remote", description: "\"remote\"" },
        peg$c145 = function(remote) {
            return Value.Undefined(remote === null);
        },
        peg$c146 = function(num, unit) { return Value.Measure(num, unit); },
        peg$c147 = function(v) { return Value.Number(v); },
        peg$c148 = "makeDate",
        peg$c149 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c150 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c151 = function(year, month, day) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c152 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return Value.Date(d);
        },
        peg$c153 = "makeTime",
        peg$c154 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c155 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c156 = function(v) { return Value.Boolean(v); },
        peg$c157 = "makeLocation",
        peg$c158 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c159 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c160 = "$context",
        peg$c161 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c162 = "location",
        peg$c163 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c164 = "home",
        peg$c165 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c166 = "work",
        peg$c167 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c168 = "current_location",
        peg$c169 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c170 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c171 = "enum",
        peg$c172 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c173 = function(v) { return Value.Enum(v); },
        peg$c174 = function(v) { return Value.String(v);
        },
        peg$c175 = "$event",
        peg$c176 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c177 = "title",
        peg$c178 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c179 = "body",
        peg$c180 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c181 = "type",
        peg$c182 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c183 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c184 = "^^",
        peg$c185 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c186 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c187 = "Measure",
        peg$c188 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c189 = function(unit) { return Type.Measure(unit); },
        peg$c190 = "Array",
        peg$c191 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c192 = function(type) { return Type.Array(type); },
        peg$c193 = "Enum",
        peg$c194 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c195 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c196 = "Entity",
        peg$c197 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c198 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c199 = "Any",
        peg$c200 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c201 = function() { return Type.Any; },
        peg$c202 = "Boolean",
        peg$c203 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c204 = function() { return Type.Boolean; },
        peg$c205 = "String",
        peg$c206 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c207 = function() { return Type.String; },
        peg$c208 = "Number",
        peg$c209 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c210 = function() { return Type.Number; },
        peg$c211 = "Location",
        peg$c212 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c213 = function() { return Type.Location; },
        peg$c214 = "Date",
        peg$c215 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c216 = function() { return Type.Date; },
        peg$c217 = "Time",
        peg$c218 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c219 = function() { return Type.Time; },
        peg$c220 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c221 = "EmailAddress",
        peg$c222 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c223 = function() { return Type.Entity('tt:email_address'); },
        peg$c224 = "PhoneNumber",
        peg$c225 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c226 = function() { return Type.Entity('tt:phone_number'); },
        peg$c227 = "Picture",
        peg$c228 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c229 = function() { return Type.Entity('tt:picture'); },
        peg$c230 = "Resource",
        peg$c231 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c232 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c233 = "URL",
        peg$c234 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c235 = function() { return Type.Entity('tt:url'); },
        peg$c236 = "Username",
        peg$c237 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c238 = function() { return Type.Entity('tt:username'); },
        peg$c239 = "Hashtag",
        peg$c240 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c241 = function() { return Type.Entity('tt:hashtag'); },
        peg$c242 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c243 = "true",
        peg$c244 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c245 = function() { return true; },
        peg$c246 = "false",
        peg$c247 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c248 = function() { return false; },
        peg$c249 = "max",
        peg$c250 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c251 = "min",
        peg$c252 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c253 = "sum",
        peg$c254 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c255 = "avg",
        peg$c256 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c257 = "count",
        peg$c258 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c259 = "argmax",
        peg$c260 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c261 = "argmin",
        peg$c262 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c263 = /^[^\\"]/,
        ...
        peg$c279 = { type: "other", description: "string" },
        peg$c280 = "\"",
        peg$c281 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c282 = function(chars) { return chars.join(''); },
        peg$c283 = "'",
        peg$c284 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c285 = { type: "other", description: "digit" },
        peg$c286 = /^[0-9]/,
        peg$c287 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c288 = { type: "other", description: "number" },
        peg$c289 = "-",
        peg$c290 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c291 = "e",
        peg$c292 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c293 = function(num) { return parseFloat(num); },
        peg$c294 = /^[A-Za-z_]/,
        peg$c295 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c296 = /^[A-Za-z0-9_]/,
        peg$c297 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c298 = { type: "other", description: "ident" },
        peg$c299 = /^[A-Za-z0-9_\-]/,
        peg$c300 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c301 = { type: "other", description: "classident" },
        peg$c302 = { type: "other", description: "whitespace" },
        peg$c303 = /^[ \r\n\t\x0B]/,
        peg$c304 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c305 = { type: "other", description: "comment" },
        peg$c306 = "/*",
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c150(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
