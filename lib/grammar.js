module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c166 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c167 = "^^",
        peg$c168 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c169 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c170 = "Measure",
        peg$c171 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c172 = function(unit) { return Type.Measure(unit); },
        peg$c173 = "Array",
        peg$c174 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c175 = function(type) { return Type.Array(type); },
        peg$c176 = "Enum",
        peg$c177 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c178 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c179 = "Entity",
        peg$c180 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c181 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c182 = "Any",
        peg$c183 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c184 = function() { return Type.Any; },
        peg$c185 = "Boolean",
        peg$c186 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c187 = function() { return Type.Boolean; },
        peg$c188 = "String",
        peg$c189 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c190 = function() { return Type.String; },
        peg$c191 = "Number",
        peg$c192 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c193 = function() { return Type.Number; },
        peg$c194 = "Location",
        peg$c195 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c196 = function() { return Type.Location; },
        peg$c197 = "Date",
        peg$c198 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c199 = function() { return Type.Date; },
        peg$c200 = "Time",
        peg$c201 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c202 = function() { return Type.Time; },
        peg$c203 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c204 = "EmailAddress",
        peg$c205 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c206 = function() { return Type.Entity('tt:email_address'); },
        peg$c207 = "PhoneNumber",
        peg$c208 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c209 = function() { return Type.Entity('tt:phone_number'); },
        peg$c210 = "Picture",
        peg$c211 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c212 = function() { return Type.Entity('tt:picture'); },
        peg$c213 = "Resource",
        peg$c214 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c215 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c216 = "URL",
        peg$c217 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c218 = function() { return Type.Entity('tt:url'); },
        peg$c219 = "Username",
        peg$c220 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c221 = function() { return Type.Entity('tt:username'); },
        peg$c222 = "Hashtag",
        peg$c223 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c224 = function() { return Type.Entity('tt:hashtag'); },
        peg$c225 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c226 = "true",
        peg$c227 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c228 = function() { return true; },
        peg$c229 = "false",
        peg$c230 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c231 = function() { return false; },
        peg$c232 = /^[^\\"]/,
        ...
        peg$c248 = { type: "other", description: "string" },
        peg$c249 = "\"",
        peg$c250 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c251 = function(chars) { return chars.join(''); },
        peg$c252 = "'",
        peg$c253 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c254 = { type: "other", description: "digit" },
        peg$c255 = /^[0-9]/,
        peg$c256 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c257 = { type: "other", description: "number" },
        peg$c258 = "-",
        peg$c259 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c260 = "e",
        peg$c261 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c262 = function(num) { return parseFloat(num); },
        peg$c263 = /^[A-Za-z_]/,
        peg$c264 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c265 = /^[A-Za-z0-9_]/,
        peg$c266 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c267 = { type: "other", description: "ident" },
        peg$c268 = /^[A-Za-z0-9_\-]/,
        peg$c269 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c270 = { type: "other", description: "classident" },
        peg$c271 = { type: "other", description: "whitespace" },
        peg$c272 = /^[ \r\n\t\x0B]/,
        peg$c273 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c274 = { type: "other", description: "comment" },
        peg$c275 = "/*",
