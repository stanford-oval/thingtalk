module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c41 = function(first_name, rest_names, values) {
        ...
        peg$c43 = "id",
        peg$c44 = { type: "literal", value: "id", description: "\"id\"" },
        peg$c45 = "principal",
        peg$c46 = { type: "literal", value: "principal", description: "\"principal\"" },
        peg$c47 = "=",
        ...
        peg$c53 = function(filters) { return take(filters, 2); },
        peg$c54 = function(fn, name, value) {
            return Filter(name, fn, value);
        },
        peg$c55 = function(name, op, value) {
            return Filter(name, op, value);
        },
        peg$c56 = function(outputs) { return take(outputs, 2); },
        peg$c57 = ":=",
        peg$c58 = { type: "literal", value: ":=", description: "\":=\"" },
        peg$c59 = function(name, param) {
            return OutputParam(name, param);
        },
        peg$c60 = "contains",
        peg$c61 = { type: "literal", value: "contains", description: "\"contains\"" },
        peg$c62 = ">=",
        ...
        peg$c75 = function(name) { return Value.VarRef(name); },
        peg$c76 = "$undefined",
        peg$c77 = { type: "literal", value: "$undefined", description: "\"$undefined\"" },
        peg$c78 = "remote",
        peg$c79 = { type: "literal", value: "remote", description: "\"remote\"" },
        peg$c80 = function(remote) {
            return Value.Undefined(remote === null);
        },
        peg$c81 = function(num, unit) { return Value.Measure(num, unit); },
        peg$c82 = function(v) { return Value.Number(v); },
        peg$c83 = "makeDate",
        peg$c84 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c85 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c86 = function(year, month, day) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c87 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return Value.Date(d);
        },
        peg$c88 = "makeTime",
        peg$c89 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c90 = function(hour, minute) {
            return Value.Time(hour, minute);
        },
        peg$c91 = function(v) { return Value.Boolean(v); },
        peg$c92 = "makeLocation",
        peg$c93 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c94 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lon, lat, display !== null ? display[2] : null));
        },
        peg$c95 = "$context",
        peg$c96 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c97 = "location",
        peg$c98 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c99 = "home",
        peg$c100 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c101 = "work",
        peg$c102 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c103 = "current_location",
        peg$c104 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c105 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c106 = "enum",
        peg$c107 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c108 = function(v) { return Value.Enum(v); },
        peg$c109 = function(v) { return Value.String(v);
        },
        peg$c110 = "$event",
        peg$c111 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c112 = "title",
        peg$c113 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c114 = "body",
        peg$c115 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c116 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c117 = "^^",
        peg$c118 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c119 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c120 = "Measure",
        peg$c121 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c122 = function(unit) { return Type.Measure(unit); },
        peg$c123 = "Array",
        peg$c124 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c125 = function(type) { return Type.Array(type); },
        peg$c126 = "Enum",
        peg$c127 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c128 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c129 = "Entity",
        peg$c130 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c131 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c132 = "Any",
        ...
        peg$c150 = "Time",
        peg$c151 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c152 = function() { return Type.Time; },
        peg$c153 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c154 = "EmailAddress",
        peg$c155 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c156 = function() { return Type.Entity('tt:email_address'); },
        peg$c157 = "PhoneNumber",
        peg$c158 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c159 = function() { return Type.Entity('tt:phone_number'); },
        peg$c160 = "Picture",
        peg$c161 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c162 = function() { return Type.Entity('tt:picture'); },
        peg$c163 = "Resource",
        peg$c164 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c165 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c166 = "URL",
        peg$c167 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c168 = function() { return Type.Entity('tt:url'); },
        peg$c169 = "Username",
        peg$c170 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c171 = function() { return Type.Entity('tt:username'); },
        peg$c172 = "Hashtag",
        peg$c173 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c174 = function() { return Type.Entity('tt:hashtag'); },
        peg$c175 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c176 = "true",
        ...
        peg$c201 = function(chars) { return chars.join(''); },
        peg$c202 = "'",
        peg$c203 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c204 = { type: "other", description: "digit" },
        peg$c205 = /^[0-9]/,
        peg$c206 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c207 = { type: "other", description: "number" },
        peg$c208 = "-",
        ...
        peg$c213 = /^[A-Za-z_]/,
        peg$c214 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c215 = /^[A-Za-z0-9_]/,
        peg$c216 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c217 = { type: "other", description: "ident" },
        peg$c218 = /^[A-Za-z0-9_\-]/,
        peg$c219 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c220 = { type: "other", description: "classident" },
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c85(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
