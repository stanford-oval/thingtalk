module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c60 = function(name) { return Selector.GlobalName(name); },
        peg$c61 = "@(",
        peg$c62 = { type: "literal", value: "@(", description: "\"@(\"" },
        peg$c63 = function(values) { return Selector.Attributes(values); },
        peg$c64 = "=",
        ...
        peg$c70 = function() { return Expression.Null; },
        peg$c71 = "||",
        peg$c72 = { type: "literal", value: "||", description: "\"||\"" },
        peg$c73 = function(lhs, rhs) { return rhs.reduce(function(lhs, rhs) { return Expression.BinaryOp(lhs, rhs[2], rhs[0]); }, lhs); },
        peg$c74 = "&&",
        ...
        peg$c86 = function(op, arg) { return Expression.UnaryOp(arg, op); },
        peg$c87 = function(lhs, member) { return member !== null ? Expression.MemberRef(lhs, member[3]) : lhs; },
        peg$c88 = function(name) { return Expression.VarRef(name); },
        peg$c89 = function(first, rest) { return Expression.Tuple([first].concat(take(rest, 2))); },
        peg$c90 = function(subexp, comma) { return comma !== null ? Expression.Tuple([subexp]) : subexp; },
        peg$c91 = "$",
        peg$c92 = { type: "literal", value: "$", description: "\"$\"" },
        peg$c93 = function(name, args) {
            return Expression.FunctionCall(name, args === null ? [] : args);
        },
        peg$c94 = function(first, rest) {
            return [first].concat(take(rest, 2))
        },
        peg$c95 = function() { return Expression.Array([]); },
        peg$c96 = function(first, rest) { return Expression.Array([first].concat(take(rest, 2))); },
        peg$c97 = function(val) {
            return Expression.Constant(val);
        },
        peg$c98 = { type: "other", description: "literal" },
        peg$c99 = function(val) { return Value.Boolean(val); },
        peg$c100 = "^^",
        peg$c101 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c102 = function(val, type) {
                if (type != null)
        ...
        peg$c105 = function(val) { return Value.Number(val / 100); },
        peg$c106 = function(val, unit) { return Value.Measure(val, unit); },
        peg$c107 = function(val) { return Value.Number(val); },
        peg$c108 = "Measure",
        peg$c109 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c110 = function(unit) { return Type.Measure(unit); },
        peg$c111 = "Array",
        peg$c112 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c113 = function(type) { return Type.Array(type); },
        peg$c114 = "Map",
        peg$c115 = { type: "literal", value: "Map", description: "\"Map\"" },
        peg$c116 = function(key, value) { return Type.Map(key, value); },
        peg$c117 = "Enum",
        peg$c118 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c119 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c120 = "Entity",
        peg$c121 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c122 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c123 = "Any",
        peg$c124 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c125 = function() { return Type.Any; },
        peg$c126 = "Boolean",
        peg$c127 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c128 = function() { return Type.Boolean; },
        peg$c129 = "String",
        peg$c130 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c131 = "Password",
        peg$c132 = { type: "literal", value: "Password", description: "\"Password\"" },
        peg$c133 = function() { return Type.String; },
        peg$c134 = "Number",
        peg$c135 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c136 = function() { return Type.Number; },
        peg$c137 = "Location",
        peg$c138 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c139 = function() { return Type.Location; },
        peg$c140 = "Date",
        peg$c141 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c142 = function() { return Type.Date; },
        peg$c143 = "Time",
        peg$c144 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c145 = function() { return Type.Time; },
        peg$c146 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c147 = "EmailAddress",
        peg$c148 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c149 = function() { return Type.Entity('tt:email_address'); },
        peg$c150 = "PhoneNumber",
        peg$c151 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c152 = function() { return Type.Entity('tt:phone_number'); },
        peg$c153 = "Picture",
        peg$c154 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c155 = function() { return Type.Entity('tt:picture'); },
        peg$c156 = "Resource",
        peg$c157 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c158 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c159 = "URL",
        peg$c160 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c161 = function() { return Type.Entity('tt:url'); },
        peg$c162 = "Username",
        peg$c163 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c164 = function() { return Type.Entity('tt:username'); },
        peg$c165 = "Hashtag",
        peg$c166 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c167 = function() { return Type.Entity('tt:hashtag'); },
        peg$c168 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c169 = { type: "other", description: "comparator" },
        peg$c170 = ">=",
        ...
        peg$c185 = "on",
        peg$c186 = { type: "literal", value: "on", description: "\"on\"" },
        peg$c187 = "true",
        ...
        peg$c215 = { type: "other", description: "digit" },
        peg$c216 = /^[0-9]/,
        peg$c217 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c218 = { type: "other", description: "number" },
        peg$c219 = "e",
        peg$c220 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c221 = function(num) { return parseFloat(num); },
        peg$c222 = /^[A-Za-z_]/,
        peg$c223 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c224 = /^[A-Za-z0-9_]/,
        peg$c225 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c226 = { type: "other", description: "ident" },
