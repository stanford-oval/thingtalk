module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c106 = function(num, unit) { return Value.Measure(num, unit); },
        peg$c107 = function(v) { return Value.Number(v); },
        peg$c108 = "makeDate",
        peg$c109 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c110 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c111 = function(year, month, day) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c112 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return Value.Date(d);
        },
        peg$c113 = "makeTime",
        peg$c114 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c115 = function(hour, minute) {
            return Value.Time(hour, minute);
        },
        peg$c116 = function(v) { return Value.Boolean(v); },
        peg$c117 = "makeLocation",
        peg$c118 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c119 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c120 = "$context",
        peg$c121 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c122 = "location",
        peg$c123 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c124 = "home",
        peg$c125 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c126 = "work",
        peg$c127 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c128 = "current_location",
        peg$c129 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c130 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c131 = "enum",
        peg$c132 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c133 = function(v) { return Value.Enum(v); },
        peg$c134 = function(v) { return Value.String(v);
        },
        peg$c135 = "$event",
        peg$c136 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c137 = "title",
        peg$c138 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c139 = "body",
        peg$c140 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c141 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c142 = "^^",
        peg$c143 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c144 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c145 = "Measure",
        peg$c146 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c147 = function(unit) { return Type.Measure(unit); },
        peg$c148 = "Array",
        peg$c149 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c150 = function(type) { return Type.Array(type); },
        peg$c151 = "Enum",
        peg$c152 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c153 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c154 = "Entity",
        peg$c155 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c156 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c157 = "Any",
        peg$c158 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c159 = function() { return Type.Any; },
        peg$c160 = "Boolean",
        peg$c161 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c162 = function() { return Type.Boolean; },
        peg$c163 = "String",
        peg$c164 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c165 = function() { return Type.String; },
        peg$c166 = "Number",
        peg$c167 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c168 = function() { return Type.Number; },
        peg$c169 = "Location",
        peg$c170 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c171 = function() { return Type.Location; },
        peg$c172 = "Date",
        peg$c173 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c174 = function() { return Type.Date; },
        peg$c175 = "Time",
        peg$c176 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c177 = function() { return Type.Time; },
        peg$c178 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c179 = "EmailAddress",
        peg$c180 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c181 = function() { return Type.Entity('tt:email_address'); },
        peg$c182 = "PhoneNumber",
        peg$c183 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c184 = function() { return Type.Entity('tt:phone_number'); },
        peg$c185 = "Picture",
        peg$c186 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c187 = function() { return Type.Entity('tt:picture'); },
        peg$c188 = "Resource",
        peg$c189 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c190 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c191 = "URL",
        peg$c192 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c193 = function() { return Type.Entity('tt:url'); },
        peg$c194 = "Username",
        peg$c195 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c196 = function() { return Type.Entity('tt:username'); },
        peg$c197 = "Hashtag",
        peg$c198 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c199 = function() { return Type.Entity('tt:hashtag'); },
        peg$c200 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c201 = "true",
        peg$c202 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c203 = function() { return true; },
        peg$c204 = "false",
        ...
        peg$c226 = function(chars) { return chars.join(''); },
        peg$c227 = "'",
        peg$c228 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c229 = { type: "other", description: "digit" },
        peg$c230 = /^[0-9]/,
        ...
        peg$c245 = { type: "other", description: "classident" },
        peg$c246 = { type: "other", description: "whitespace" },
        peg$c247 = /^[ \r\n\t\x0B]/,
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c110(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
