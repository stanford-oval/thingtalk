module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c162 = function(num, unit) { return Value.Measure(num, unit); },
        peg$c163 = function(v) { return Value.Number(v); },
        peg$c164 = "makeDate",
        peg$c165 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c166 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c167 = function(year, month, day) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c168 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return new Value.Date(d, null);
        },
        peg$c169 = function(unit) {
            if (Units.UnitsToBaseUnit[unit] !== 'ms')
                error('Invalid time unit ' + unit);
            return unit;
        },
        peg$c170 = "start_of",
        peg$c171 = { type: "literal", value: "start_of", description: "\"start_of\"" },
        peg$c172 = "end_of",
        peg$c173 = { type: "literal", value: "end_of", description: "\"end_of\"" },
        peg$c174 = function(edge, unit) {
            if (unit === 'ms' || unit === 's')
        ...
        peg$c176 = "delta",
        peg$c177 = { type: "literal", value: "delta", description: "\"delta\"" },
        peg$c178 = function(date, offset) {
            return Value.Date(date.value, offset);
        },
        peg$c179 = "makeTime",
        peg$c180 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c181 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c182 = function(v) { return Value.Boolean(v); },
        peg$c183 = "makeLocation",
        peg$c184 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c185 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c186 = "$context",
        peg$c187 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c188 = "location",
        peg$c189 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c190 = "home",
        peg$c191 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c192 = "work",
        peg$c193 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c194 = "current_location",
        peg$c195 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c196 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c197 = "enum",
        peg$c198 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c199 = function(v) { return Value.Enum(v); },
        peg$c200 = function(v) { return Value.String(v);
        },
        peg$c201 = "$event",
        peg$c202 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c203 = "title",
        peg$c204 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c205 = "body",
        peg$c206 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c207 = "type",
        peg$c208 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c209 = "program_id",
        peg$c210 = { type: "literal", value: "program_id", description: "\"program_id\"" },
        peg$c211 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c212 = "^^",
        peg$c213 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c214 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c215 = function(values) {
            return Value.Array(values || []);
        },
        peg$c216 = "Measure",
        peg$c217 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c218 = function(unit) { return Type.Measure(unit); },
        peg$c219 = "Array",
        peg$c220 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c221 = function(type) { return Type.Array(type); },
        peg$c222 = "Enum",
        peg$c223 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c224 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c225 = "Entity",
        peg$c226 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c227 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c228 = "Any",
        peg$c229 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c230 = function() { return Type.Any; },
        peg$c231 = "Boolean",
        peg$c232 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c233 = function() { return Type.Boolean; },
        peg$c234 = "String",
        peg$c235 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c236 = function() { return Type.String; },
        peg$c237 = "Number",
        peg$c238 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c239 = function() { return Type.Number; },
        peg$c240 = "Location",
        peg$c241 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c242 = function() { return Type.Location; },
        peg$c243 = "Date",
        peg$c244 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c245 = function() { return Type.Date; },
        peg$c246 = "Time",
        peg$c247 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c248 = function() { return Type.Time; },
        peg$c249 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c250 = "EmailAddress",
        peg$c251 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c252 = function() { return Type.Entity('tt:email_address'); },
        peg$c253 = "PhoneNumber",
        peg$c254 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c255 = function() { return Type.Entity('tt:phone_number'); },
        peg$c256 = "Picture",
        peg$c257 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c258 = function() { return Type.Entity('tt:picture'); },
        peg$c259 = "Resource",
        peg$c260 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c261 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c262 = "URL",
        peg$c263 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c264 = function() { return Type.Entity('tt:url'); },
        peg$c265 = "Username",
        peg$c266 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c267 = function() { return Type.Entity('tt:username'); },
        peg$c268 = "Hashtag",
        peg$c269 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c270 = function() { return Type.Entity('tt:hashtag'); },
        peg$c271 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c272 = "true",
        peg$c273 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c274 = function() { return true; },
        peg$c275 = "false",
        ...
        peg$c282 = "sum",
        peg$c283 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c284 = "avg",
        peg$c285 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c286 = "count",
        peg$c287 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c288 = "argmax",
        peg$c289 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c290 = "argmin",
        peg$c291 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c292 = /^[^\\"]/,
        ...
        peg$c308 = { type: "other", description: "string" },
        peg$c309 = "\"",
        peg$c310 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c311 = function(chars) { return chars.join(''); },
        peg$c312 = "'",
        peg$c313 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c314 = { type: "other", description: "digit" },
        peg$c315 = /^[0-9]/,
        peg$c316 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c317 = { type: "other", description: "number" },
        peg$c318 = "-",
        peg$c319 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c320 = "e",
        peg$c321 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c322 = function(num) { return parseFloat(num); },
        peg$c323 = /^[A-Za-z_]/,
        peg$c324 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c325 = /^[A-Za-z0-9_]/,
        peg$c326 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c327 = { type: "other", description: "ident" },
        peg$c328 = /^[A-Za-z0-9_\-]/,
        peg$c329 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c330 = { type: "other", description: "classident" },
        peg$c331 = { type: "other", description: "whitespace" },
        peg$c332 = /^[ \r\n\t\x0B]/,
        peg$c333 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c334 = { type: "other", description: "comment" },
        peg$c335 = "/*",
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c166(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
                        ...
                        if (s0 === peg$FAILED) {
                          ...
                          if (s0 === peg$FAILED) {
                            ...
                            if (s0 === peg$FAILED) {
                              ...
                              if (s0 === peg$FAILED) {
                                s0 = peg$currPos;
                                if (input.substr(peg$currPos, 11) === peg$c253) {
                                  s1 = peg$c253;
                                  peg$currPos += 11;
                                } else {
                                  s1 = peg$FAILED;
