module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c294 = "_",
        peg$c295 = { type: "literal", value: "_", description: "\"_\"" },
        ...
        peg$c298 = "Measure",
        peg$c299 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c300 = function(unit) { return Type.Measure(unit); },
        peg$c301 = "Enum",
        peg$c302 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c303 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c304 = "Entity",
        peg$c305 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c306 = function(prefix, type) { return Type.Entity(prefix + ':' + type); },
        peg$c307 = "Boolean",
        peg$c308 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c309 = function() { return Type.Boolean; },
        peg$c310 = "String",
        peg$c311 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c312 = function() { return Type.String; },
        peg$c313 = "Number",
        peg$c314 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c315 = function() { return Type.Number; },
        peg$c316 = "Currency",
        peg$c317 = { type: "literal", value: "Currency", description: "\"Currency\"" },
        peg$c318 = function() { return Type.Currency; },
        peg$c319 = "Location",
        peg$c320 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c321 = function() { return Type.Location; },
        peg$c322 = "Date",
        peg$c323 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c324 = function() { return Type.Date; },
        peg$c325 = "Time",
        peg$c326 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c327 = function() { return Type.Time; },
        peg$c328 = "EmailAddress",
        peg$c329 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c330 = function() { return Type.Entity('tt:email_address'); },
        peg$c331 = "PhoneNumber",
        peg$c332 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c333 = function() { return Type.Entity('tt:phone_number'); },
        peg$c334 = "Picture",
        peg$c335 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c336 = function() { return Type.Entity('tt:picture'); },
        peg$c337 = "Resource",
        peg$c338 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c339 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c340 = "URL",
        peg$c341 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c342 = function() { return Type.Entity('tt:url'); },
        peg$c343 = "Username",
        peg$c344 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c345 = function() { return Type.Entity('tt:username'); },
        peg$c346 = "Hashtag",
        peg$c347 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c348 = function() { return Type.Entity('tt:hashtag'); },
        peg$c349 = "Type",
        peg$c350 = { type: "literal", value: "Type", description: "\"Type\"" },
        peg$c351 = function() { return Type.Type; },
        peg$c352 = "Array",
        peg$c353 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c354 = function(type) { return Type.Array(type); },
        peg$c355 = "Any",
        peg$c356 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c357 = function() { return Type.Any; },
        peg$c358 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c359 = "Table",
        peg$c360 = { type: "literal", value: "Table", description: "\"Table\"" },
        peg$c361 = function() { return Type.Table; },
        peg$c362 = "Stream",
        peg$c363 = { type: "literal", value: "Stream", description: "\"Stream\"" },
        peg$c364 = function() { return Type.Stream; },
        peg$c365 = "ArgMap",
        peg$c366 = { type: "literal", value: "ArgMap", description: "\"ArgMap\"" },
        peg$c367 = function() { return Type.ArgMap; },
        peg$c368 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c369 = { type: "other", description: "comparison operator" },
        peg$c370 = ">=",
        ...
        peg$c380 = "true",
        peg$c381 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c382 = function() { return true; },
        peg$c383 = "false",
        peg$c384 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c385 = function() { return false; },
        peg$c386 = "mixin",
        peg$c387 = { type: "literal", value: "mixin", description: "\"mixin\"" },
        peg$c388 = "this",
        peg$c389 = { type: "literal", value: "this", description: "\"this\"" },
        peg$c390 = /^[^\\"]/,
        ...
        peg$c406 = { type: "other", description: "string" },
        peg$c407 = "\"",
        peg$c408 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c409 = function(chars) { return chars.join(''); },
        peg$c410 = "'",
        peg$c411 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c412 = { type: "other", description: "digit" },
        peg$c413 = /^[0-9]/,
        peg$c414 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c415 = { type: "other", description: "number" },
        peg$c416 = "e",
        peg$c417 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c418 = function(num) { return parseFloat(num); },
        peg$c419 = /^[A-Za-z_]/,
        peg$c420 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c421 = /^[A-Za-z0-9_]/,
        peg$c422 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c423 = { type: "other", description: "identifier" },
        peg$c424 = function(v) {
        ...
        peg$c425 = /^[A-Za-z0-9_\-]/,
        peg$c426 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c427 = { type: "other", description: "classidentifier" },
        peg$c428 = { type: "other", description: "whitespace" },
        peg$c429 = /^[ \r\n\t\x0B]/,
        peg$c430 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c431 = { type: "other", description: "comment" },
        peg$c432 = "/*",
        peg$c433 = { type: "literal", value: "/*", description: "\"/*\"" },
        peg$c434 = /^[^*]/,
        peg$c435 = { type: "class", value: "[^*]", description: "[^*]" },
        peg$c436 = /^[^\/]/,
        peg$c437 = { type: "class", value: "[^/]", description: "[^/]" },
        peg$c438 = "*/",
