module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c172 = function(date, op, delta, unit) {
        ...
        peg$c173 = "makeTime",
        peg$c174 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c175 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c176 = function(v) { return Value.Boolean(v); },
        peg$c177 = "makeLocation",
        peg$c178 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c179 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c180 = "$context",
        peg$c181 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c182 = "location",
        peg$c183 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c184 = "home",
        peg$c185 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c186 = "work",
        peg$c187 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c188 = "current_location",
        peg$c189 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c190 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c191 = "enum",
        peg$c192 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c193 = function(v) { return Value.Enum(v); },
        peg$c194 = function(v) { return Value.String(v);
        },
        peg$c195 = "$event",
        peg$c196 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c197 = "title",
        peg$c198 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c199 = "body",
        peg$c200 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c201 = "type",
        peg$c202 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c203 = "program_id",
        peg$c204 = { type: "literal", value: "program_id", description: "\"program_id\"" },
        peg$c205 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c206 = "^^",
        peg$c207 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c208 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c209 = function(values) {
            return Value.Array(values || []);
        },
        peg$c210 = "Measure",
        peg$c211 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c212 = function(unit) { return Type.Measure(unit); },
        peg$c213 = "Array",
        peg$c214 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c215 = function(type) { return Type.Array(type); },
        peg$c216 = "Enum",
        peg$c217 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c218 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c219 = "Entity",
        peg$c220 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c221 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c222 = "Any",
        peg$c223 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c224 = function() { return Type.Any; },
        peg$c225 = "Boolean",
        peg$c226 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c227 = function() { return Type.Boolean; },
        peg$c228 = "String",
        peg$c229 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c230 = function() { return Type.String; },
        peg$c231 = "Number",
        peg$c232 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c233 = function() { return Type.Number; },
        peg$c234 = "Location",
        peg$c235 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c236 = function() { return Type.Location; },
        peg$c237 = "Date",
        peg$c238 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c239 = function() { return Type.Date; },
        peg$c240 = "Time",
        peg$c241 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c242 = function() { return Type.Time; },
        peg$c243 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c244 = "EmailAddress",
        peg$c245 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c246 = function() { return Type.Entity('tt:email_address'); },
        peg$c247 = "PhoneNumber",
        peg$c248 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c249 = function() { return Type.Entity('tt:phone_number'); },
        peg$c250 = "Picture",
        peg$c251 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c252 = function() { return Type.Entity('tt:picture'); },
        peg$c253 = "Resource",
        peg$c254 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c255 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c256 = "URL",
        peg$c257 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c258 = function() { return Type.Entity('tt:url'); },
        peg$c259 = "Username",
        peg$c260 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c261 = function() { return Type.Entity('tt:username'); },
        peg$c262 = "Hashtag",
        peg$c263 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c264 = function() { return Type.Entity('tt:hashtag'); },
        peg$c265 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c266 = "true",
        peg$c267 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c268 = function() { return true; },
        peg$c269 = "false",
        peg$c270 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c271 = function() { return false; },
        peg$c272 = "max",
        peg$c273 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c274 = "min",
        peg$c275 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c276 = "sum",
        peg$c277 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c278 = "avg",
        peg$c279 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c280 = "count",
        peg$c281 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c282 = "argmax",
        peg$c283 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c284 = "argmin",
        peg$c285 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c286 = /^[^\\"]/,
        ...
        peg$c302 = { type: "other", description: "string" },
        peg$c303 = "\"",
        peg$c304 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c305 = function(chars) { return chars.join(''); },
        peg$c306 = "'",
        peg$c307 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c308 = { type: "other", description: "digit" },
        peg$c309 = /^[0-9]/,
        peg$c310 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c311 = { type: "other", description: "number" },
        peg$c312 = "e",
        peg$c313 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c314 = function(num) { return parseFloat(num); },
        peg$c315 = /^[A-Za-z_]/,
        peg$c316 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c317 = /^[A-Za-z0-9_]/,
        peg$c318 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c319 = { type: "other", description: "ident" },
        peg$c320 = /^[A-Za-z0-9_\-]/,
        peg$c321 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c322 = { type: "other", description: "classident" },
        peg$c323 = { type: "other", description: "whitespace" },
        peg$c324 = /^[ \r\n\t\x0B]/,
        peg$c325 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c326 = { type: "other", description: "comment" },
        peg$c327 = "/*",
        ...
        peg$c337 = /^[^\n]/,
        peg$c338 = { type: "class", value: "[^\\n]", description: "[^\\n]" },
        peg$c339 = "\n",
        peg$c340 = { type: "literal", value: "\n", description: "\"\\n\"" },
