module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c79 = "id",
        peg$c80 = { type: "literal", value: "id", description: "\"id\"" },
        peg$c81 = "principal",
        peg$c82 = { type: "literal", value: "principal", description: "\"principal\"" },
        peg$c83 = "=",
        ...
        peg$c97 = function(or) { return or; },
        peg$c98 = function(v) { return v ? BooleanExpression.True : BooleanExpression.False; },
        peg$c99 = "!",
        peg$c100 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c101 = function(or) { return BooleanExpression.Not(or); },
        peg$c102 = function(f) { return BooleanExpression.Atom(f); },
        peg$c103 = function(outputs) { return take(outputs, 2); },
        peg$c104 = ":=",
        peg$c105 = { type: "literal", value: ":=", description: "\":=\"" },
        peg$c106 = function(name, param) {
        ...
        peg$c122 = function(name) { return Value.VarRef(name); },
        peg$c123 = "$undefined",
        peg$c124 = { type: "literal", value: "$undefined", description: "\"$undefined\"" },
        peg$c125 = "remote",
        peg$c126 = { type: "literal", value: "remote", description: "\"remote\"" },
        peg$c127 = function(remote) {
            return Value.Undefined(remote === null);
        },
        peg$c128 = function(num, unit) { return Value.Measure(num, unit); },
        peg$c129 = function(v) { return Value.Number(v); },
        peg$c130 = "makeDate",
        peg$c131 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c132 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c134 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return Value.Date(d);
        },
        peg$c135 = "makeTime",
        peg$c136 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c137 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c138 = function(v) { return Value.Boolean(v); },
        peg$c139 = "makeLocation",
        peg$c140 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c141 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c142 = "$context",
        peg$c143 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c144 = "location",
        peg$c145 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c146 = "home",
        peg$c147 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c148 = "work",
        peg$c149 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c150 = "current_location",
        peg$c151 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c152 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c153 = "enum",
        peg$c154 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c155 = function(v) { return Value.Enum(v); },
        peg$c156 = function(v) { return Value.String(v);
        },
        peg$c157 = "$event",
        peg$c158 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c159 = "title",
        peg$c160 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c161 = "body",
        peg$c162 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c163 = "type",
        peg$c164 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c165 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c166 = "^^",
        peg$c167 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c168 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c169 = "Measure",
        peg$c170 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c171 = function(unit) { return Type.Measure(unit); },
        peg$c172 = "Array",
        peg$c173 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c174 = function(type) { return Type.Array(type); },
        peg$c175 = "Enum",
        peg$c176 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c177 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c178 = "Entity",
        peg$c179 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c180 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c181 = "Any",
        peg$c182 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c183 = function() { return Type.Any; },
        peg$c184 = "Boolean",
        peg$c185 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c186 = function() { return Type.Boolean; },
        peg$c187 = "String",
        peg$c188 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c189 = function() { return Type.String; },
        peg$c190 = "Number",
        peg$c191 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c192 = function() { return Type.Number; },
        peg$c193 = "Location",
        peg$c194 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c195 = function() { return Type.Location; },
        peg$c196 = "Date",
        peg$c197 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c198 = function() { return Type.Date; },
        peg$c199 = "Time",
        peg$c200 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c201 = function() { return Type.Time; },
        peg$c202 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c203 = "EmailAddress",
        peg$c204 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c205 = function() { return Type.Entity('tt:email_address'); },
        peg$c206 = "PhoneNumber",
        peg$c207 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c208 = function() { return Type.Entity('tt:phone_number'); },
        peg$c209 = "Picture",
        peg$c210 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c211 = function() { return Type.Entity('tt:picture'); },
        peg$c212 = "Resource",
        peg$c213 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c214 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c215 = "URL",
        peg$c216 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c217 = function() { return Type.Entity('tt:url'); },
        peg$c218 = "Username",
        peg$c219 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c220 = function() { return Type.Entity('tt:username'); },
        peg$c221 = "Hashtag",
        peg$c222 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c223 = function() { return Type.Entity('tt:hashtag'); },
        peg$c224 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c225 = "true",
        ...
        peg$c250 = function(chars) { return chars.join(''); },
        peg$c251 = "'",
        peg$c252 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c253 = { type: "other", description: "digit" },
        peg$c254 = /^[0-9]/,
        ...
        peg$c259 = "e",
        peg$c260 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c261 = function(num) { return parseFloat(num); },
        peg$c262 = /^[A-Za-z_]/,
        peg$c263 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c264 = /^[A-Za-z0-9_]/,
        peg$c265 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c266 = { type: "other", description: "ident" },
        peg$c267 = /^[A-Za-z0-9_\-]/,
        peg$c268 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c269 = { type: "other", description: "classident" },
        peg$c270 = { type: "other", description: "whitespace" },
        peg$c271 = /^[ \r\n\t\x0B]/,
        peg$c272 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c273 = { type: "other", description: "comment" },
        peg$c274 = "/*",
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c132(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
