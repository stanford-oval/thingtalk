module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c166 = "makeTime",
        peg$c167 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c168 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c169 = function(v) { return Value.Boolean(v); },
        peg$c170 = "makeLocation",
        peg$c171 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c172 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c173 = "$context",
        peg$c174 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c175 = "location",
        peg$c176 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c177 = "home",
        peg$c178 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c179 = "work",
        peg$c180 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c181 = "current_location",
        peg$c182 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c183 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c184 = "enum",
        peg$c185 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c186 = function(v) { return Value.Enum(v); },
        peg$c187 = function(v) { return Value.String(v);
        },
        peg$c188 = "$event",
        peg$c189 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c190 = "title",
        peg$c191 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c192 = "body",
        peg$c193 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c194 = "type",
        peg$c195 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c196 = "program_id",
        peg$c197 = { type: "literal", value: "program_id", description: "\"program_id\"" },
        peg$c198 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c199 = "^^",
        peg$c200 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c201 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c202 = function(values) {
            return Value.Array(values || []);
        },
        peg$c203 = "Measure",
        peg$c204 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c205 = function(unit) { return Type.Measure(unit); },
        peg$c206 = "Array",
        peg$c207 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c208 = function(type) { return Type.Array(type); },
        peg$c209 = "Enum",
        peg$c210 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c211 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c212 = "Entity",
        peg$c213 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c214 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c215 = "Any",
        peg$c216 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c217 = function() { return Type.Any; },
        peg$c218 = "Boolean",
        peg$c219 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c220 = function() { return Type.Boolean; },
        peg$c221 = "String",
        peg$c222 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c223 = function() { return Type.String; },
        peg$c224 = "Number",
        peg$c225 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c226 = function() { return Type.Number; },
        peg$c227 = "Location",
        peg$c228 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c229 = function() { return Type.Location; },
        peg$c230 = "Date",
        peg$c231 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c232 = function() { return Type.Date; },
        peg$c233 = "Time",
        peg$c234 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c235 = function() { return Type.Time; },
        peg$c236 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c237 = "EmailAddress",
        peg$c238 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c239 = function() { return Type.Entity('tt:email_address'); },
        peg$c240 = "PhoneNumber",
        peg$c241 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c242 = function() { return Type.Entity('tt:phone_number'); },
        peg$c243 = "Picture",
        peg$c244 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c245 = function() { return Type.Entity('tt:picture'); },
        peg$c246 = "Resource",
        peg$c247 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c248 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c249 = "URL",
        peg$c250 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c251 = function() { return Type.Entity('tt:url'); },
        peg$c252 = "Username",
        peg$c253 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c254 = function() { return Type.Entity('tt:username'); },
        peg$c255 = "Hashtag",
        peg$c256 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c257 = function() { return Type.Entity('tt:hashtag'); },
        peg$c258 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c259 = "true",
        peg$c260 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c261 = function() { return true; },
        peg$c262 = "false",
        peg$c263 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c264 = function() { return false; },
        peg$c265 = "max",
        peg$c266 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c267 = "min",
        peg$c268 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c269 = "sum",
        peg$c270 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c271 = "avg",
        peg$c272 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c273 = "count",
        peg$c274 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c275 = "argmax",
        peg$c276 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c277 = "argmin",
        peg$c278 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c279 = /^[^\\"]/,
        ...
        peg$c298 = function(chars) { return chars.join(''); },
        peg$c299 = "'",
        peg$c300 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c301 = { type: "other", description: "digit" },
        peg$c302 = /^[0-9]/,
        peg$c303 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c304 = { type: "other", description: "number" },
        peg$c305 = "-",
        peg$c306 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c307 = "e",
        peg$c308 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c309 = function(num) { return parseFloat(num); },
        peg$c310 = /^[A-Za-z_]/,
        peg$c311 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c312 = /^[A-Za-z0-9_]/,
        peg$c313 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c314 = { type: "other", description: "ident" },
        peg$c315 = /^[A-Za-z0-9_\-]/,
        peg$c316 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c317 = { type: "other", description: "classident" },
        peg$c318 = { type: "other", description: "whitespace" },
        peg$c319 = /^[ \r\n\t\x0B]/,
        peg$c320 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c321 = { type: "other", description: "comment" },
        peg$c322 = "/*",
