module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c96 = "to",
        peg$c97 = { type: "literal", value: "to", description: "\"to\"" },
        ...
        peg$c101 = function(from, to, stream) {
          return new Ast.Table.TimeSeries(from, to, stream, null);
        },
        peg$c102 = "aggregate",
        peg$c103 = { type: "literal", value: "aggregate", description: "\"aggregate\"" },
        peg$c104 = "count",
        peg$c105 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c106 = function(table) {
          return new Ast.Table.Aggregation(table, '*', 'count', null);
        },
        peg$c107 = "argmin",
        peg$c108 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c109 = "argmax",
        peg$c110 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c111 = function(op, num, field, table) {
        ...
        peg$c141 = function(first, rest, stream) {
        ...
        peg$c178 = function(or) { return or; },
        peg$c179 = function(v) { return v ? Ast.BooleanExpression.True : Ast.BooleanExpression.False; },
        peg$c180 = "!",
        peg$c181 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c182 = function(bool) { return new Ast.BooleanExpression.Not(bool); },
        ...
        peg$c198 = function(expr) { return new Ast.ScalarExpression.Boolean(expr); },
        ...
        peg$c208 = "makeDate",
        peg$c209 = { type: "literal", value: "makeDate", description: "\"makeDate\"" },
        peg$c210 = function(year, month, day, hours, minutes, seconds) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c211 = function(year, month, day) {
            var d = new Date;
            d.setFullYear(year);
            d.setMonth(month-1);
            d.setDate(day);
        ...
        peg$c212 = function(unix) {
            var d = new Date;
            d.setTime(unix);
            return new Ast.Value.Date(d, null);
        },
        peg$c213 = function(unit) {
            if (Units.UnitsToBaseUnit[unit] !== 'ms')
                error('Invalid time unit ' + unit);
            return unit;
        },
        peg$c214 = "start_of",
        peg$c215 = { type: "literal", value: "start_of", description: "\"start_of\"" },
        peg$c216 = "end_of",
        peg$c217 = { type: "literal", value: "end_of", description: "\"end_of\"" },
        peg$c218 = function(edge, unit) {
            if (unit === 'ms' || unit === 's')
        ...
        peg$c220 = "delta",
        peg$c221 = { type: "literal", value: "delta", description: "\"delta\"" },
        peg$c222 = function(date, offset) {
                                                  ...
                                                  if (s23 !== peg$FAILED) {
                                                    ...
                                                    if (s24 !== peg$FAILED) {
                                                      ...
                                                      if (s25 !== peg$FAILED) {
                                                        ...
                                                        if (s26 !== peg$FAILED) {
                                                          peg$savedPos = s0;
                                                          s1 = peg$c210(s4, s8, s12, s16, s20, s24);
                                                          s0 = s1;
                                                        } else {
                                                          peg$currPos = s0;
                                                          s0 = peg$FAILED;
