module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c168 = "makeDelta",
        peg$c169 = { type: "literal", value: "makeDelta", description: "\"makeDelta\"" },
        peg$c170 = "years",
        peg$c171 = { type: "literal", value: "years", description: "\"years\"" },
        peg$c172 = function() {
        ...
        peg$c177 = "delta",
        peg$c178 = { type: "literal", value: "delta", description: "\"delta\"" },
        peg$c179 = "months",
        peg$c180 = { type: "literal", value: "months", description: "\"months\"" },
        peg$c181 = "weeks",
        peg$c182 = { type: "literal", value: "weeks", description: "\"weeks\"" },
        peg$c183 = "days",
        peg$c184 = { type: "literal", value: "days", description: "\"days\"" },
        peg$c185 = "hours",
        peg$c186 = { type: "literal", value: "hours", description: "\"hours\"" },
        peg$c187 = "minutes",
        peg$c188 = { type: "literal", value: "minutes", description: "\"minutes\"" },
        peg$c189 = "seconds",
        peg$c190 = { type: "literal", value: "seconds", description: "\"seconds\"" },
        peg$c191 = function(date, op, years, months, weeks, days, hours, minutes, seconds) {
        ...
        peg$c192 = "makeTime",
        peg$c193 = { type: "literal", value: "makeTime", description: "\"makeTime\"" },
        peg$c194 = function(hour, minute, second) {
            return Value.Time(hour, minute, second !== null ? second[2] : 0);
        },
        peg$c195 = function(v) { return Value.Boolean(v); },
        peg$c196 = "makeLocation",
        peg$c197 = { type: "literal", value: "makeLocation", description: "\"makeLocation\"" },
        peg$c198 = function(lat, lon, display) {
            return Value.Location(Location.Absolute(lat, lon, display !== null ? display[2] : null));
        },
        peg$c199 = "$context",
        peg$c200 = { type: "literal", value: "$context", description: "\"$context\"" },
        peg$c201 = "location",
        peg$c202 = { type: "literal", value: "location", description: "\"location\"" },
        peg$c203 = "home",
        peg$c204 = { type: "literal", value: "home", description: "\"home\"" },
        peg$c205 = "work",
        peg$c206 = { type: "literal", value: "work", description: "\"work\"" },
        peg$c207 = "current_location",
        peg$c208 = { type: "literal", value: "current_location", description: "\"current_location\"" },
        peg$c209 = function(ctx) {
            return Value.Location(Location.Relative(ctx));
        },
        peg$c210 = "enum",
        peg$c211 = { type: "literal", value: "enum", description: "\"enum\"" },
        peg$c212 = function(v) { return Value.Enum(v); },
        peg$c213 = function(v) { return Value.String(v);
        },
        peg$c214 = "$event",
        peg$c215 = { type: "literal", value: "$event", description: "\"$event\"" },
        peg$c216 = "title",
        peg$c217 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c218 = "body",
        peg$c219 = { type: "literal", value: "body", description: "\"body\"" },
        peg$c220 = "type",
        peg$c221 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c222 = "program_id",
        peg$c223 = { type: "literal", value: "program_id", description: "\"program_id\"" },
        peg$c224 = function(evt) {
            return Value.Event(evt !== null ? evt[2] : null);
        },
        peg$c225 = "^^",
        peg$c226 = { type: "literal", value: "^^", description: "\"^^\"" },
        peg$c227 = function(v, prefix, entity, display) {
            return Value.Entity(v, (prefix || 'tt:') + entity, display !== null ? display[2] : null);
        },
        peg$c228 = function(values) {
            return Value.Array(values || []);
        },
        peg$c229 = "Measure",
        peg$c230 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c231 = function(unit) { return Type.Measure(unit); },
        peg$c232 = "Array",
        peg$c233 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c234 = function(type) { return Type.Array(type); },
        peg$c235 = "Enum",
        peg$c236 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c237 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c238 = "Entity",
        peg$c239 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c240 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c241 = "Any",
        peg$c242 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c243 = function() { return Type.Any; },
        peg$c244 = "Boolean",
        peg$c245 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c246 = function() { return Type.Boolean; },
        peg$c247 = "String",
        peg$c248 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c249 = function() { return Type.String; },
        peg$c250 = "Number",
        peg$c251 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c252 = function() { return Type.Number; },
        peg$c253 = "Location",
        peg$c254 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c255 = function() { return Type.Location; },
        peg$c256 = "Date",
        peg$c257 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c258 = function() { return Type.Date; },
        peg$c259 = "Time",
        peg$c260 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c261 = function() { return Type.Time; },
        peg$c262 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c263 = "EmailAddress",
        peg$c264 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c265 = function() { return Type.Entity('tt:email_address'); },
        peg$c266 = "PhoneNumber",
        peg$c267 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c268 = function() { return Type.Entity('tt:phone_number'); },
        peg$c269 = "Picture",
        peg$c270 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c271 = function() { return Type.Entity('tt:picture'); },
        peg$c272 = "Resource",
        peg$c273 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c274 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c275 = "URL",
        peg$c276 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c277 = function() { return Type.Entity('tt:url'); },
        peg$c278 = "Username",
        peg$c279 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c280 = function() { return Type.Entity('tt:username'); },
        peg$c281 = "Hashtag",
        peg$c282 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c283 = function() { return Type.Entity('tt:hashtag'); },
        peg$c284 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c285 = "true",
        peg$c286 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c287 = function() { return true; },
        peg$c288 = "false",
        peg$c289 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c290 = function() { return false; },
        peg$c291 = "max",
        peg$c292 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c293 = "min",
        peg$c294 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c295 = "sum",
        peg$c296 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c297 = "avg",
        peg$c298 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c299 = "count",
        peg$c300 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c301 = "argmax",
        peg$c302 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c303 = "argmin",
        peg$c304 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c305 = /^[^\\"]/,
        ...
        peg$c321 = { type: "other", description: "string" },
        peg$c322 = "\"",
        peg$c323 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c324 = function(chars) { return chars.join(''); },
        peg$c325 = "'",
        peg$c326 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c327 = { type: "other", description: "digit" },
        peg$c328 = /^[0-9]/,
        peg$c329 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c330 = { type: "other", description: "number" },
        peg$c331 = "e",
        peg$c332 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c333 = function(num) { return parseFloat(num); },
        peg$c334 = /^[A-Za-z_]/,
        peg$c335 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c336 = /^[A-Za-z0-9_]/,
        peg$c337 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c338 = { type: "other", description: "ident" },
        peg$c339 = /^[A-Za-z0-9_\-]/,
        peg$c340 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c341 = { type: "other", description: "classident" },
        peg$c342 = { type: "other", description: "whitespace" },
        peg$c343 = /^[ \r\n\t\x0B]/,
        peg$c344 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c345 = { type: "other", description: "comment" },
        peg$c346 = "/*",
                            ...
                            if (s12 !== peg$FAILED) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    peg$savedPos = s0;
                                    s1 = peg$c191(s1, s3, s8, s9, s10, s11, s12, s13, s14);
                                    s0 = s1;
                                  } else {
                                    peg$currPos = s0;
                                    s0 = peg$FAILED;
                    ...
                    if (s7 !== peg$FAILED) {
                      ...
                      if (s8 !== peg$FAILED) {
                        ...
                        if (s9 === peg$FAILED) {
                          ...
                          if (s9 === peg$FAILED) {
                            if (input.substr(peg$currPos, 16) === peg$c207) {
                              s9 = peg$c207;
                              peg$currPos += 16;
                            } else {
                              s9 = peg$FAILED;
