module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c190 = "Measure",
        peg$c191 = { type: "literal", value: "Measure", description: "\"Measure\"" },
        peg$c192 = function(unit) { return Type.Measure(unit); },
        peg$c193 = "Array",
        peg$c194 = { type: "literal", value: "Array", description: "\"Array\"" },
        peg$c195 = function(type) { return Type.Array(type); },
        peg$c196 = "Enum",
        peg$c197 = { type: "literal", value: "Enum", description: "\"Enum\"" },
        peg$c198 = function(first, rest) { return Type.Enum([first].concat(take(rest, 2))); },
        peg$c199 = "Entity",
        peg$c200 = { type: "literal", value: "Entity", description: "\"Entity\"" },
        peg$c201 = function(prefix, type) { return Type.Entity((prefix !== null ? prefix : 'tt:') + type); },
        peg$c202 = "Any",
        peg$c203 = { type: "literal", value: "Any", description: "\"Any\"" },
        peg$c204 = function() { return Type.Any; },
        peg$c205 = "Boolean",
        peg$c206 = { type: "literal", value: "Boolean", description: "\"Boolean\"" },
        peg$c207 = function() { return Type.Boolean; },
        peg$c208 = "String",
        peg$c209 = { type: "literal", value: "String", description: "\"String\"" },
        peg$c210 = function() { return Type.String; },
        peg$c211 = "Number",
        peg$c212 = { type: "literal", value: "Number", description: "\"Number\"" },
        peg$c213 = function() { return Type.Number; },
        peg$c214 = "Location",
        peg$c215 = { type: "literal", value: "Location", description: "\"Location\"" },
        peg$c216 = function() { return Type.Location; },
        peg$c217 = "Date",
        peg$c218 = { type: "literal", value: "Date", description: "\"Date\"" },
        peg$c219 = function() { return Type.Date; },
        peg$c220 = "Time",
        peg$c221 = { type: "literal", value: "Time", description: "\"Time\"" },
        peg$c222 = function() { return Type.Time; },
        peg$c223 = function(first, rest) { return Type.Tuple([first].concat(take(rest, 2))); },
        peg$c224 = "EmailAddress",
        peg$c225 = { type: "literal", value: "EmailAddress", description: "\"EmailAddress\"" },
        peg$c226 = function() { return Type.Entity('tt:email_address'); },
        peg$c227 = "PhoneNumber",
        peg$c228 = { type: "literal", value: "PhoneNumber", description: "\"PhoneNumber\"" },
        peg$c229 = function() { return Type.Entity('tt:phone_number'); },
        peg$c230 = "Picture",
        peg$c231 = { type: "literal", value: "Picture", description: "\"Picture\"" },
        peg$c232 = function() { return Type.Entity('tt:picture'); },
        peg$c233 = "Resource",
        peg$c234 = { type: "literal", value: "Resource", description: "\"Resource\"" },
        peg$c235 = function() { return Type.Entity('tt:rdf_resource'); },
        peg$c236 = "URL",
        peg$c237 = { type: "literal", value: "URL", description: "\"URL\"" },
        peg$c238 = function() { return Type.Entity('tt:url'); },
        peg$c239 = "Username",
        peg$c240 = { type: "literal", value: "Username", description: "\"Username\"" },
        peg$c241 = function() { return Type.Entity('tt:username'); },
        peg$c242 = "Hashtag",
        peg$c243 = { type: "literal", value: "Hashtag", description: "\"Hashtag\"" },
        peg$c244 = function() { return Type.Entity('tt:hashtag'); },
        peg$c245 = function(invalid) { throw new TypeError("Invalid type " + invalid); },
        peg$c246 = "true",
        peg$c247 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c248 = function() { return true; },
        peg$c249 = "false",
        peg$c250 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c251 = function() { return false; },
        peg$c252 = "max",
        peg$c253 = { type: "literal", value: "max", description: "\"max\"" },
        peg$c254 = "min",
        peg$c255 = { type: "literal", value: "min", description: "\"min\"" },
        peg$c256 = "sum",
        peg$c257 = { type: "literal", value: "sum", description: "\"sum\"" },
        peg$c258 = "avg",
        peg$c259 = { type: "literal", value: "avg", description: "\"avg\"" },
        peg$c260 = "count",
        peg$c261 = { type: "literal", value: "count", description: "\"count\"" },
        peg$c262 = "argmax",
        peg$c263 = { type: "literal", value: "argmax", description: "\"argmax\"" },
        peg$c264 = "argmin",
        peg$c265 = { type: "literal", value: "argmin", description: "\"argmin\"" },
        peg$c266 = /^[^\\"]/,
        ...
        peg$c282 = { type: "other", description: "string" },
        peg$c283 = "\"",
        peg$c284 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c285 = function(chars) { return chars.join(''); },
        peg$c286 = "'",
        peg$c287 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c288 = { type: "other", description: "digit" },
        peg$c289 = /^[0-9]/,
        ...
        peg$c294 = "e",
        peg$c295 = { type: "literal", value: "e", description: "\"e\"" },
        peg$c296 = function(num) { return parseFloat(num); },
        peg$c297 = /^[A-Za-z_]/,
        peg$c298 = { type: "class", value: "[A-Za-z_]", description: "[A-Za-z_]" },
        peg$c299 = /^[A-Za-z0-9_]/,
        peg$c300 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c301 = { type: "other", description: "ident" },
        peg$c302 = /^[A-Za-z0-9_\-]/,
        peg$c303 = { type: "class", value: "[A-Za-z0-9_-]", description: "[A-Za-z0-9_-]" },
        peg$c304 = { type: "other", description: "classident" },
        peg$c305 = { type: "other", description: "whitespace" },
        peg$c306 = /^[ \r\n\t\x0B]/,
        peg$c307 = { type: "class", value: "[ \\r\\n\\t\\v]", description: "[ \\r\\n\\t\\v]" },
        peg$c308 = { type: "other", description: "comment" },
        peg$c309 = "/*",
