...
function likeTest(a, b) {
    ...
    if (typeof a === 'string' && typeof b === 'string') {
        ...
        if (editDistance(a, b) <= 1 && b.length > 1)
            return true;
        if (a.indexOf(b) >= 0)
            return true;
...
function recurrentTimeSpecContains(spec, timeOrDate) {
...
module.exports.recurrentTimeSpecContains = recurrentTimeSpecContains;
...
module.exports.timeAdd = function(time, offset) {
    return Time.fromSeconds(time + Math.round(offset/1000));
};
module.exports.timeSub = function(time, offset) {
    return Time.fromSeconds(time - Math.round(offset/1000));
};
