...
class Location {
    ...
    constructor(lat, lon, display) {
         ...
         * Longitude value.
         * @type {number}
         * @deprecated Use {module:Builtin.Location#lon}
         */
        this.x = lon;
         ...
         * Latitude value.
         * @type {number}
         * @deprecated Use {module:Builtin.Location#lat}
         */
        this.y = lat;
     ...
     * to be an instance of the {@link module:Builtin.Location} class, and can be any object
