...
rule = tblname:('table' _ '=' _ string_value _ ':')? _ once:'once'? _ trigger:trigger _ queries:('=>' _ query _)* _ '=>' _ actions:action_list {
    return new Rule(trigger, take(queries, 2), actions, once !== null, tblname !== null ? tblname[4].value : null);
}
