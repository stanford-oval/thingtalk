...
class_member = modifiers:query_modifiers? _ type:('query' / 'action') __ name:ident _ args:function_param_decl_list _ ';' _ {
...
keyword = literal_bool / ('now' / 'new' / 'as' / 'of' / 'notify' / 'return' / 'join' / 'class') !identchar
