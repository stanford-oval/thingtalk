...
rule_part = channel_spec / keyword_rule_part / member_binding / left_binding / right_binding /
    builtin_predicate / condition

channel_spec = channel_spec:(builtin_spec / device_channel_spec) _ params:channel_param_list {
