...
primary_bool_expr = '(' _ or:or_expr _ ')' { return or; } /
    ...
    get_predicate / function_style_predicate / compute_predicate
...
long_weekday_value = 'new' __ 'Date' _ '(' _ day:quoted_weekday _ ',' _ hours:literal_number _ ',' _ minutes:literal_number _ ',' _ seconds:literal_number _ ')' {
    let time = new Ast.Value.Time(new Ast.Time.Absolute(hours, minutes, seconds));
    return new Ast.Value.Date(new Ast.WeekDay(day, time));
}
short_weekday_value = 'new' __ 'Date' _ '(' _ day:quoted_weekday _ ')' {
    return new Ast.Value.Date(new Ast.WeekDay(day, null));
}
...
quoted_weekday = '"' day:weekday '"' { return day; } / "'" day:weekday "'" { return day; }
