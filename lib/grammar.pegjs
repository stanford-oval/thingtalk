...
entity_value = v:literal_string _ '^^' _ prefix:qualified_name _ ':' _ entity:ident _ display:('(' _ literal_string _')' _)? {
...
type_ref = 'Measure' _ '(' _ unit:ident? _ ')' { return Type.Measure(unit); } /
    ...
    'Entity' _ '(' _ prefix:qualified_name _ ':' _ type:ident _ ')' { return Type.Entity(prefix + ':' + type); } /
    'Any' { return Type.Any; } /
