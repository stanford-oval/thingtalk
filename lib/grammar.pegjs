...
date_delta = 'makeDelta' _ '('
    ('years' _ '=' _ years:literal_number _ )?
    (months:literal_number _ )?
    (weeks:literal_number _)?
    (days:literal_number _)?
    (hours:literal_number _)?
    (minutes: literal_number _)?
    (seconds: literal_number _)? ')' {

}
relative_date_value = date:(long_date_value / short_date_value / unix_date_value / now) _ op:('+' / '-') _ 'delta' _ '('
