...
dialogue_state = _ '$dialogue' _ dialogueAct:short_function_name _ ';' _ history:dialogue_history_item* _ {
    return new Ast.DialogueState(location(), dialogueAct[0].kind, dialogueAct[1], history);
}
