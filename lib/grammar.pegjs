...
permission_rule = _ first:(permission_function / 'now') _ '=>' _ second:(permission_function / 'notify') _ third:('=>' _ (permission_function / 'notify') )? _ {
    if (first === 'now')
...
action = notify_action / other_action
