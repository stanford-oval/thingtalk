...
function_def = modifiers:query_modifiers? _ type:('query' / 'action') __ name:ident _ args:function_param_decl_list _ ';' _ {
...
keyword = literal_bool / ('let' / 'now' / 'new' / 'as' / 'of' / 'in' / 'out' / 'req' / 'opt' / 'notify' / 'return' / 'join' / 'edge' / 'monitor' / 'class' / 'extends' / 'mixin' / 'this' / 'import' / 'null' / 'enum' / 'aggregate') !identchar
