...
query = q:trigger_or_query &(_ '=>') { return q; } / log_query
...
argm_lhs = '[' _ '*' _ ']' {return [];} / '[' _ argm_output_cols _ ']'
argm_rhs = type:argm _ '(' _ field:ident _ ', ' _ cols:argm_lhs _ ')' {return Aggregation(type, field, cols);}
argm_output_cols = (first:ident rest:(', ' _ ident _)*) {return [first].concat(take(rest, 2));}
