...
command_program = _ 'command' __ name:ident _ params:decl_param_list _ '{' _ statement:(short_command / long_command) _ '}' _ {
...
statement = keyword_decl / compute_module / short_command / long_command / rule
...
rule_part = invocation / keyword_rule_part / member_binding / binding /
    builtin_predicate / condition

short_command = commands:rule_part_list ';' {
    return Statement.Command([commands]);
}
long_command = '$now' _ outputs:('=>' _ outputs:rule_part_list _)+ ';' {
