...
module.exports = class ExecEnvironment {
    ...
    getCurrentEvent() {
        if (this.currentChannel !== null && this.currentChannel.device.kind === 'org.thingpedia.builtin.thingengine.remote') {
            // apply masquerading for @remote, remove __principal, __token, __kindChannel
            return this.triggerValue.slice(3);
        } else if (this.queryInput !== null) {
