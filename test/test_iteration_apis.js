...
var TEST_CASES = [
    ...
    ['table: Invocation(Device(com.xkcd, , ), get_comic, , )',
    ...
    ['table: Invocation(Device(com.xkcd, , ), get_comic, InputParam(number, Undefined(true)), )',
     'action: Invocation(Builtin, notify, , )'],
    ['Device(com.xkcd, , ) com.xkcd:get_comic',
    ...
    ['table: Invocation(Device(com.xkcd, , ), get_comic, InputParam(number, Number(1234)), )',
     'action: Invocation(Builtin, notify, , )'],
    ['Device(com.xkcd, , ) com.xkcd:get_comic',
    ...
    ['table: Invocation(Device(com.instagram, , ), get_pictures, , )',
     'table: Invocation(Device(org.thingpedia.weather, , ), current, , )',
     'action: Invocation(Builtin, notify, , )'],
