...
var TEST_CASES = [
    ...
    'get the last cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[1]) => notify;`,
    'get the first cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[2]) => notify;`,
    'get the second cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[-2]) => notify;`,
    'get the second to last cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[3]) => notify;`,
    'get the third cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[-3]) => notify;`,
    'get the 3rd last cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[4]) => notify;`,
    'get the 4th cat picture and then notify you', 'Thecatapi'],
    [`now => result(@com.thecatapi.get[-4]) => notify;`,
    'get the 4th last cat picture and then notify you', 'Thecatapi'],
